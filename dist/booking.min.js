!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof exports?exports.TimekitBooking=t(require("jquery")):e.TimekitBooking=t(e.jQuery)}(this,function(e){return function(e){function t(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return e[i].call(r.exports,r,r.exports,t),r.loaded=!0,r.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function i(){var e,t,i,u={},d=function(){e=r(u.targetEl),0===e.length&&(e=r("#hourwidget")),0===e.length&&l.logError("No target DOM element was found ("+u.targetEl+")"),e.addClass("bookingjs"),e.children(":not(script)").remove()},h=function(){u.app&&(u.timekitConfig.app=u.app),o.configure(u.timekitConfig)},f=function(){o.setUser(u.email,u.apiToken)},p=function(){var e={};u.timekitFindTime.calendar_ids||u.timekitFindTime.user_ids||(e.emails=[u.email]),r.extend(e,u.timekitFindTime),l.doCallback("findTimeStarted",u,e),o.findTime(e).then(function(e){l.doCallback("findTimeSuccessful",u,e),e.data.length>0&&x(e.data)}).catch(function(e){l.doCallback("findTimeFailed",u,e),l.logError(["An error with Timekit FindTime occured, context:",e])})},g=function(){var e={url:"/findtime/team",method:"post",data:u.timekitFindTimeTeam};r.each(u.timekitFindTimeTeam.users,function(e,t){r.extend(t,u.timekitFindTime),t.calendar_ids||t.user_ids||(t.emails=[t._email])}),l.doCallback("findTimeTeamStarted",u,e),o.makeRequest(e).then(function(e){l.doCallback("findTimeTeamSuccessful",u,e),e.data.length>0&&x(e.data)}).catch(function(e){l.doCallback("findTimeTeamFailed",u,e),l.logError(["An error with Timekit FindTimeTeam occured, context:",e])})},m=function(){l.doCallback("GetBookingSlotsStarted",u);var e={url:"/bookings/groups",method:"get"};u.widgetId&&(e.params={search:"widget.id:"+u.widgetId}),o.makeRequest(e).then(function(e){var t=e.data.map(function(e){return{title:e.attributes.event_info.what,start:e.attributes.event_info.start,end:e.attributes.event_info.end,booking:e}});l.doCallback("getBookingSlotsSuccessful",u,e),t.length>0&&x(t)}).catch(function(e){l.doCallback("getBookingSlotsFailed",u,e),l.logError(["An error with Timekit GetBookings occured, context:",e])})},v=function(){t.fullCalendar("removeEventSources"),"group_customer"===u.bookingGraph||"group_customer_payment"===u.bookingGraph?m():u.timekitFindTimeTeam?g():p()},b=function(e){t.fullCalendar("gotoDate",e);var n=s(e).format("H");y(n)},y=function(e){if("agendaWeek"===t.fullCalendar("getView").name){var n=t.fullCalendar("option","slotDuration"),i=30;n&&(i=n.slice(3,5));var o=t.find(".fc-slats .fc-minor"),a=r(o[0]).height()*(60/i),l=0;if(u.fullCalendar.minTime){var c=s(u.fullCalendar.minTime,"HH:mm:ss").format("H");l=a*c}var d=a*e-l,h=t.find(".fc-scroller"),f=h.height(),p=h.scrollTop(),g=h.find(".fc-time-grid").height();d>p&&d<p+f||(d>g-f&&(d=g-f),h.animate({scrollTop:d}))}},w=function(){var t=s().utcOffset()/60,i=n(56),c=n(9),d=r(c.render({timezoneIcon:i,loadingText:u.localization.strings.timezoneHelperLoading,loading:!0}));e.addClass("has-timezonehelper"),e.append(d);var h={email:u.email};l.doCallback("getUserTimezoneStarted",u,h),o.getUserTimezone(h).then(function(e){l.doCallback("getUserTimezoneSuccessful",u,e);var o=e.data.utc_offset,s=t-o,c=Math.abs(t-o),h=s>0?"ahead":"behind",f=n(9),p=r(f.render({timezoneIcon:i,timezoneDifference:0!==c,timezoneDifferent:a.sprintf(u.localization.strings.timezoneHelperDifferent,c,h,u.name),timezoneSame:a.sprintf(u.localization.strings.timezoneHelperSame,u.name)}));d.replaceWith(p)}).catch(function(e){l.doCallback("getUserTimezoneFailed",u,e),l.logError(["An error with Timekit getUserTimezone occured, context:",e])})},k=function(){var n=A(u.fullCalendar.defaultView),i={defaultView:n.view,height:n.height,eventClick:S,windowResize:function(){var e=A();t.fullCalendar("changeView",e.view),t.fullCalendar("option","height",e.height)}};r.extend(!0,i,u.fullCalendar),t=r('<div class="bookingjs-calendar empty-calendar">'),e.append(t),t.fullCalendar(i),e.addClass("show"),l.doCallback("fullCalendarInitialized",u)},S=function(e){u.disableConfirmPage?(r(".fc-event-clicked").removeClass("fc-event-clicked"),r(this).addClass("fc-event-clicked"),l.doCallback("clickTimeslot",u,e)):T(e)},A=function(n){n=n||t.fullCalendar("getView").name;var i=u.fullCalendar.defaultView,r=420;return e.width()<480?(r=380,e.addClass("is-small"),u.avatar&&(r-=15),"agendaWeek"!==n&&"basicDay"!==n||(i="basicDay")):e.removeClass("is-small"),u.bookingFields.comment.enabled&&(r+=84),u.bookingFields.phone.enabled&&(r+=64),u.bookingFields.voip.enabled&&(r+=64),u.bookingFields.location.enabled&&(r+=64),u.localization.showTimezoneHelper||(r+=33),{height:r,view:i}},x=function(e){var n=s(e[0].start),i=s(e[0].end),r=i.diff(n,"minutes");r<=90&&t.fullCalendar("option","slotDuration","00:15:00"),t.fullCalendar("addEventSource",{events:e}),t.removeClass("empty-calendar"),u.goToFirstEvent&&b(e[0].start)},D=function(){var t=n(44),i=r(t.render({image:u.avatar}));e.addClass("has-avatar"),e.append(i)},E=function(){var t=n(45),i=r(t.render({name:u.name}));e.addClass("has-displayname"),e.append(i)},T=function(t){l.doCallback("showBookingPage",u,t);var o=n(41),c=n(42),d=u.localization.bookingDateFormat||s.localeData().longDateFormat("LL"),h=u.localization.bookingTimeFormat||s.localeData().longDateFormat("LT");i=r(c.render({chosenDate:s(t.start).format(d),chosenTime:s(t.start).format(h)+" - "+s(t.end).format(h),closeIcon:n(52),checkmarkIcon:n(51),loadingIcon:n(54),errorIcon:n(53),submitText:u.localization.strings.submitText,successMessageTitle:u.localization.strings.successMessageTitle,successMessageBody:a.sprintf(u.localization.strings.successMessageBody,'<span class="booked-email"></span>'),fields:u.bookingFields},{formFields:o}));var f=i.children(".bookingjs-form");i.children(".bookingjs-bookpage-close").click(function(e){e.preventDefault(),C();var t=r(f).hasClass("success");t&&v()}),t.users&&l.logDebug(["Available users for chosen timeslot:",t.users],u),f.submit(function(e){_(this,e,t)}),u.showCredits&&R(i),r(document).on("keyup",function(e){27===e.keyCode&&C()}),e.append(i),setTimeout(function(){i.addClass("show")},100)},C=function(){l.doCallback("closeBookingPage",u),i.removeClass("show"),setTimeout(function(){i.remove()},200),r(document).off("keyup")},_=function(e,t,n){t.preventDefault();var i=r(e);if(i.hasClass("loading")||i.hasClass("success")||i.hasClass("error")||!t.target.checkValidity()){var o=i.find(".bookingjs-form-button");return o.addClass("button-shake"),void setTimeout(function(){o.removeClass("button-shake")},500)}var a={};r.each(i.serializeArray(),function(e,t){a[t.name]=t.value}),i.addClass("loading"),l.doCallback("submitBookingForm",u,a),z(a,n).then(function(e){i.find(".booked-email").html(a.email),i.removeClass("loading").addClass("success")}).catch(function(e){M(i)})},M=function(e){var t=e.find(".bookingjs-form-button");t.addClass("button-shake"),setTimeout(function(){t.removeClass("button-shake")},500),e.removeClass("loading").addClass("error"),setTimeout(function(){e.removeClass("error")},2e3)},z=function(e,t){var n={event:{start:t.start.format(),end:t.end.format(),what:u.name+" x "+e.name,where:"TBD",description:"",calendar_id:u.calendar,participants:[e.email]},customer:{name:e.name,email:e.email,timezone:s.tz.guess()}};if(u.bookingFields.location.enabled&&(n.event.where=e.location),u.bookingFields.comment.enabled&&(n.event.description+=u.bookingFields.comment.placeholder+": "+e.comment+"\n"),u.bookingFields.phone.enabled&&(n.customer.phone=e.phone,n.event.description+=u.bookingFields.phone.placeholder+": "+e.phone+"\n"),u.bookingFields.voip.enabled&&(n.customer.voip=e.voip,n.event.description+=u.bookingFields.voip.placeholder+": "+e.voip+"\n"),r.extend(!0,n,u.timekitCreateBooking),"group_customer"!==u.bookingGraph&&"group_customer_payment"!==u.bookingGraph||(delete n.event,n.related={owner_booking_id:t.booking.id}),t.users){var i=t.users[0],a=r.grep(u.timekitFindTimeTeam.users,function(e){return i.email===e._email});if(a.length<1||!a[0]._calendar)return void l.logError(["Encountered an error when picking designated team user to receive booking",i,u.timekitFindTimeTeam.users]);o=o.asUser(i.email,i.token),n.event.calendar_id=a[0]._calendar,l.logDebug(["Creating booking for user:",i],u)}!t.users&&u.widgetId&&(n.widget_id=u.widgetId),l.doCallback("createBookingStarted",u,n);var c={"Timekit-OutputTimestampFormat":"Y-m-d "+u.localization.emailTimeFormat+" (P e)"},d=o.include("attributes","event","user").headers(c).createBooking(n);return d.then(function(e){l.doCallback("createBookingSuccessful",u,e)}).catch(function(e){l.logError(["An error with Timekit CreateBooking occured, context:",e]),l.doCallback("createBookingFailed",u,e)}),d},R=function(e){var t="widget",i=window.location.hostname.replace(/\./g,"-");u.widgetId&&(t="embedded-widget"),u.widgetSlug&&(t="hosted-widget");var o=n(43),a=n(55),s=r(o.render({timekitLogo:a,campaignName:t,campaignSource:i}));e.append(s)},H=function(e){return r.extend(!0,{},c.primary,e)},L=function(e,t,n){var i=c.presets[t][n];return i?r.extend(!0,{},e,i):e},O=function(e){(void 0===e||"object"!=typeof e||r.isEmptyObject(e))&&l.logError("No configuration was supplied or found. Please supply a config object upon library initialization");var t=H(e);return t=L(t,"timeDateFormat",t.localization.timeDateFormat),t=L(t,"bookingGraph",t.bookingGraph),t=L(t,"availabilityView",t.availabilityView),t.email||l.logError('A required config setting ("email") was missing'),t.apiToken||l.logError('A required config setting ("apiToken") was missing'),t.calendar||"group_customer"===t.bookingGraph||"group_customer_payment"===t.bookingGraph||t.timekitFindTimeTeam||l.logError('A required config setting ("calendar") was missing'),u=t,l.logDebug(["Final config:",u],u),l.logDebug(["Version:",I()],u),u},P=function(){return u},I=function(){return"1.13.0"},j=function(){return l.doCallback("renderStarted",u),d(),h(),f(),k(),v(),u.localization.showTimezoneHelper&&w(),u.avatar&&D(),u.name&&E(),l.doCallback("renderCompleted",u),this},N=function(e){return l.logDebug(["Supplied config:",e],e),!e.widgetId&&!e.widgetSlug||e.disableRemoteLoad?B(e):F(e).then(function(t){var n=t.data.config;t.data.id&&(n.widgetId=t.data.id);var i=r.extend(!0,{},n,e);l.logDebug(["Remote config:",n],i),B(i)})},F=function(e){return u=H(e),h(),e.widgetId?o.getEmbedWidget({id:e.widgetId}).catch(function(){l.logError("The widget could not be found, please double-check your widgetId")}):e.widgetSlug?o.getHostedWidget({slug:e.widgetSlug}).catch(function(){l.logError("The widget could not be found, please double-check your widgetSlug")}):void l.logError("No widget configuration, widgetSlug or widgetId found")},B=function(e){return O(e),j()},G=function(){return d(),u={},this},Y=function(){if(void 0!==t.fullCalendar)return t.fullCalendar.apply(t,arguments)};return{setConfig:O,getConfig:P,getVersion:I,render:j,init:N,destroy:G,timekitCreateBooking:z,fullCalendar:Y,timekitSdk:o}}/*!
	 * Booking.js
	 * http://timekit.io
	 *
