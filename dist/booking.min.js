!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof exports?exports.TimekitBooking=t(require("jquery")):e.TimekitBooking=t(e.jQuery)}(this,function(e){return function(e){function t(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return e[i].call(r.exports,r,r.exports,t),r.loaded=!0,r.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function i(){var e,t,i,u={},d=function(){n(49),n(50),n(52),n(51)},f=function(){e=r(u.targetEl),0===e.length&&(e=r("#hourwidget")),0===e.length&&l.logError("No target DOM element was found ("+u.targetEl+")"),e.addClass("bookingjs"),e.children(":not(script)").remove()},h=function(){u.app&&(u.timekitConfig.app=u.app),a.configure(u.timekitConfig)},p=function(){a.setUser(u.email,u.apiToken)},g=function(){var e={};u.timekitFindTime.calendar_ids||u.timekitFindTime.user_ids||(e.emails=[u.email]),r.extend(e,u.timekitFindTime),l.doCallback("findTimeStarted",u,e),a.findTime(e).then(function(e){if(l.doCallback("findTimeSuccessful",u,e),u.goToFirstEvent&&e.data.length>0){var t=e.data[0].start,n=o(t).format("H");m(t),v(n)}A(e.data)}).catch(function(e){l.doCallback("findTimeFailed",u,e),l.logError("An error with Timekit FindTime occured, context: "+e)})},m=function(e){t.fullCalendar("gotoDate",e)},v=function(e){if("agendaWeek"===t.fullCalendar("getView").name){var n=t.find(".fc-slats .fc-minor"),i=2*r(n[0]).height(),a=0;if(u.fullCalendar.minTime){var s=o(u.fullCalendar.minTime,"HH:mm:ss").format("H");a=i*s}var l=i*e-a,c=t.find(".fc-scroller"),d=c.height(),f=c.scrollTop(),h=c.find(".fc-time-grid").height();l>f&&l<f+d||(l>h-d&&(l=h-d),c.animate({scrollTop:l}))}},b=function(){var t=o().utcOffset()/60,i=n(58),c=n(11),d=r(c.render({timezoneIcon:i,loadingText:u.localization.strings.timezoneHelperLoading,loading:!0}));e.addClass("has-timezonehelper"),e.append(d);var f={email:u.email};l.doCallback("getUserTimezoneStarted",u,f),a.getUserTimezone(f).then(function(e){l.doCallback("getUserTimezoneSuccessful",u,e);var o=e.data.utc_offset,a=t-o,c=Math.abs(t-o),f=a>0?"ahead":"behind",h=n(11),p=r(h.render({timezoneIcon:i,timezoneDifference:0!==c,timezoneDifferent:s.sprintf(u.localization.strings.timezoneHelperDifferent,c,f,u.name),timezoneSame:s.sprintf(u.localization.strings.timezoneHelperSame,u.name)}));d.replaceWith(p)}).catch(function(e){l.doCallback("getUserTimezoneFailed",u,e),l.logError("An error with Timekit getUserTimezone occured, context: "+e)})},y=function(){var n=w(),i={defaultView:n.view,height:n.height,eventClick:T,windowResize:function(){var e=w();t.fullCalendar("changeView",e.view),t.fullCalendar("option","height",e.height)}};r.extend(!0,i,u.fullCalendar),t=r('<div class="bookingjs-calendar empty-calendar">'),e.append(t),t.fullCalendar(i),e.addClass("show"),l.doCallback("fullCalendarInitialized",u)},w=function(){var t="agendaWeek",n=420,i=e.width();return i<480?(t="basicDay",n=380,e.addClass("is-small"),u.avatar&&(n-=15)):e.removeClass("is-small"),u.bookingFields.comment.enabled&&(n+=84),u.bookingFields.phone.enabled&&(n+=64),u.bookingFields.voip.enabled&&(n+=64),u.bookingFields.location.enabled&&(n+=64),{height:n,view:t}},A=function(e){t.fullCalendar("addEventSource",{events:e}),t.removeClass("empty-calendar")},S=function(){var t=n(46),i=r(t.render({image:u.avatar}));e.addClass("has-avatar"),e.append(i)},k=function(){var t=n(47),i=r(t.render({name:u.name}));e.addClass("has-displayname"),e.append(i)},T=function(t){l.doCallback("showBookingPage",u,t);var a=n(43),c=n(44),d=u.localization.bookingDateFormat||o.localeData().longDateFormat("LL"),f=u.localization.bookingTimeFormat||o.localeData().longDateFormat("LT");i=r(c.render({chosenDate:o(t.start).format(d),chosenTime:o(t.start).format(f)+" - "+o(t.end).format(f),start:o(t.start).format(),end:o(t.end).format(),closeIcon:n(54),checkmarkIcon:n(53),loadingIcon:n(56),errorIcon:n(55),submitText:u.localization.strings.submitText,successMessageTitle:u.localization.strings.successMessageTitle,successMessageBody:s.sprintf(u.localization.strings.successMessageBody,'<span class="booked-email"></span>'),fields:u.bookingFields},{formFields:a})),i.children(".bookingjs-bookpage-close").click(function(e){e.preventDefault(),E()});var h=i.children(".bookingjs-form");h.submit(function(e){x(this,e)}),u.showCredits&&D(i),r(document).on("keyup",function(e){27===e.keyCode&&E()}),e.append(i),setTimeout(function(){i.addClass("show")},100)},E=function(){l.doCallback("closeBookingPage",u),i.removeClass("show"),setTimeout(function(){i.remove()},200),r(document).off("keyup")},x=function(e,t){t.preventDefault();var n=r(e);if(n.hasClass("loading")||n.hasClass("success")||n.hasClass("error")||!t.target.checkValidity()){var i=n.find(".bookingjs-form-button");return i.addClass("button-shake"),void setTimeout(function(){i.removeClass("button-shake")},500)}var o={};r.each(n.serializeArray(),function(e,t){o[t.name]=t.value}),n.addClass("loading"),l.doCallback("submitBookingForm",u,o),_(o).then(function(e){l.doCallback("createBookingSuccessful",u,e),n.find(".booked-email").html(o.email),n.removeClass("loading").addClass("success")}).catch(function(e){l.doCallback("createBookingFailed",u,e);var t=n.find(".bookingjs-form-button");t.addClass("button-shake"),setTimeout(function(){t.removeClass("button-shake")},500),n.removeClass("loading").addClass("error"),setTimeout(function(){n.removeClass("error")},2e3),l.logError("An error with Timekit createBooking occured, context: "+e)})},_=function(e){var t={event:{start:e.start,end:e.end,what:u.name+" x "+e.name,where:"TBD",description:"",calendar_id:u.calendar,participants:[e.email]},customer:{name:e.name,email:e.email,timezone:o.tz.guess()}};u.bookingFields.location.enabled&&(t.event.where=e.location),u.bookingFields.comment.enabled&&(t.event.description+=u.bookingFields.comment.placeholder+": "+e.comment+"\n"),u.bookingFields.phone.enabled&&(t.customer.phone=e.phone,t.event.description+=u.bookingFields.phone.placeholder+": "+e.phone+"\n"),u.bookingFields.voip.enabled&&(t.customer.voip=e.voip,t.event.description+=u.bookingFields.voip.placeholder+": "+e.voip+"\n"),r.extend(!0,t,u.timekitCreateBooking),l.doCallback("createBookingStarted",u,t);var n={"Timekit-OutputTimestampFormat":"Y-m-d "+u.localization.emailTimeFormat+" (P e)"};return a.include("attributes","event").headers(n).createBooking(t)},D=function(e){var t="widget",i=window.location.hostname.replace(/\./g,"-");u.widgetSlug&&(t="hosted-widget"),u.widgetId&&(t="embedded-widget");var o=n(45),a=n(57),s=r(o.render({timekitLogo:a,campaignName:t,campaignSource:i}));e.append(s)},M=function(e){return r.extend(!0,{},c.primary,e)},C=function(e){(void 0===e||"object"!=typeof e||r.isEmptyObject(e))&&l.logError("No configuration was supplied or found. Please supply a config object upon library initialization");var t=M(e),n={};"24h-dmy-mon"===t.localization.timeDateFormat?n=c.presets.timeDateFormat24hdmymon:"12h-mdy-sun"===t.localization.timeDateFormat&&(n=c.presets.timeDateFormat12hmdysun);var i=r.extend(!0,{},n,t);return n={},"instant"===t.bookingGraph?n=c.presets.bookingInstant:"confirm_decline"===t.bookingGraph&&(n=c.presets.bookingConfirmDecline),i=r.extend(!0,{},n,i),i.email&&i.apiToken&&i.calendar||l.logError('A required config setting was missing ("email", "apiToken" or "calendar")'),u=i},z=function(){return u},H=function(){return d(),f(),h(),p(),y(),g(),u.localization.showTimezoneHelper&&b(),u.avatar&&S(),u.name&&k(),l.doCallback("renderCompleted",u),this},L=function(e){return e.widgetId||e.widgetSlug?R(e).then(function(t){var n=r.extend(!0,{},t.data.config,e);O(n)}):O(e)},R=function(e){return u=M(e),h(),e.widgetId?a.getEmbedWidget({id:e.widgetId}).catch(function(){l.logError("The widget could not be found, please double-check your widgetId")}):e.widgetSlug?a.getHostedWidget({slug:e.widgetSlug}).catch(function(){l.logError("The widget could not be found, please double-check your widgetSlug")}):void l.logError("No widget configuration, widgetSlug or widgetId found")},O=function(e){return C(e),H()},B=function(){return f(),u={},this},P=function(){if(void 0!==t.fullCalendar)return t.fullCalendar.apply(t,arguments)};return{setConfig:C,getConfig:z,render:H,init:L,destroy:B,fullCalendar:P,timekitSdk:a}}/*!
	 * Booking.js
	 * Version: 1.9.3
	 * http://timekit.io
	 *
