!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof exports?exports.TimekitBooking=t(require("jquery")):e.TimekitBooking=t(e.jQuery)}(this,function(e){return function(e){function t(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return e[i].call(r.exports,r,r.exports,t),r.loaded=!0,r.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function i(){var e,t,i,u={},d=function(){n(47),n(48),n(50),n(49)},h=function(){e=r(u.targetEl),0===e.length&&(e=r("#hourwidget")),0===e.length&&l.logError("No target DOM element was found ("+u.targetEl+")"),e.addClass("bookingjs"),e.children(":not(script)").remove()},f=function(){u.app&&(u.timekitConfig.app=u.app),a.configure(u.timekitConfig)},p=function(){a.setUser(u.email,u.apiToken)},g=function(){var e={};u.timekitFindTime.calendar_ids||u.timekitFindTime.user_ids||(e.emails=[u.email]),r.extend(e,u.timekitFindTime),l.doCallback("findTimeStarted",u,e),a.findTime(e).then(function(e){l.doCallback("findTimeSuccessful",u,e),e.data.length>0&&E(e.data)}).catch(function(e){l.doCallback("findTimeFailed",u,e),l.logError(["An error with Timekit FindTime occured, context:",e])})},m=function(){var e={url:"/findtime/team",method:"post",data:u.timekitFindTimeTeam};r.each(u.timekitFindTimeTeam.users,function(e,t){r.extend(t,u.timekitFindTime),t.calendar_ids||t.user_ids||(t.emails=[t._email])}),l.doCallback("findTimeTeamStarted",u,e),a.makeRequest(e).then(function(e){l.doCallback("findTimeTeamSuccessful",u,e),e.data.length>0&&E(e.data)}).catch(function(e){l.doCallback("findTimeTeamFailed",u,e),l.logError(["An error with Timekit FindTimeTeam occured, context:",e])})},v=function(){l.doCallback("GetBookingSlotsStarted",u);var e={url:"/bookings/groups",method:"get"};u.widgetId&&(e.params={search:"widget.id:"+u.widgetId}),a.makeRequest(e).then(function(e){var t=e.data.map(function(e){return{title:e.attributes.event_info.what,start:e.attributes.event_info.start,end:e.attributes.event_info.end,booking:e}});l.doCallback("getBookingSlotsSuccessful",u,e),t.length>0&&E(t)}).catch(function(e){l.doCallback("getBookingSlotsFailed",u,e),l.logError(["An error with Timekit GetBookings occured, context:",e])})},b=function(){t.fullCalendar("removeEventSources"),"group_customer"===u.bookingGraph||"group_customer_payment"===u.bookingGraph?v():u.timekitFindTimeTeam?m():g()},y=function(e){t.fullCalendar("gotoDate",e);var n=o(e).format("H");w(n)},w=function(e){if("agendaWeek"===t.fullCalendar("getView").name){var n=t.fullCalendar("option","slotDuration"),i=30;n&&(i=n.slice(3,5));var a=t.find(".fc-slats .fc-minor"),s=r(a[0]).height()*(60/i),l=0;if(u.fullCalendar.minTime){var c=o(u.fullCalendar.minTime,"HH:mm:ss").format("H");l=s*c}var d=s*e-l,h=t.find(".fc-scroller"),f=h.height(),p=h.scrollTop(),g=h.find(".fc-time-grid").height();d>p&&d<p+f||(d>g-f&&(d=g-f),h.animate({scrollTop:d}))}},k=function(){var t=o().utcOffset()/60,i=n(56),c=n(9),d=r(c.render({timezoneIcon:i,loadingText:u.localization.strings.timezoneHelperLoading,loading:!0}));e.addClass("has-timezonehelper"),e.append(d);var h={email:u.email};l.doCallback("getUserTimezoneStarted",u,h),a.getUserTimezone(h).then(function(e){l.doCallback("getUserTimezoneSuccessful",u,e);var o=e.data.utc_offset,a=t-o,c=Math.abs(t-o),h=a>0?"ahead":"behind",f=n(9),p=r(f.render({timezoneIcon:i,timezoneDifference:0!==c,timezoneDifferent:s.sprintf(u.localization.strings.timezoneHelperDifferent,c,h,u.name),timezoneSame:s.sprintf(u.localization.strings.timezoneHelperSame,u.name)}));d.replaceWith(p)}).catch(function(e){l.doCallback("getUserTimezoneFailed",u,e),l.logError(["An error with Timekit getUserTimezone occured, context:",e])})},S=function(){var n=x(u.fullCalendar.defaultView),i={defaultView:n.view,height:n.height,eventClick:A,windowResize:function(){var e=x();t.fullCalendar("changeView",e.view),t.fullCalendar("option","height",e.height)}};r.extend(!0,i,u.fullCalendar),t=r('<div class="bookingjs-calendar empty-calendar">'),e.append(t),t.fullCalendar(i),e.addClass("show"),l.doCallback("fullCalendarInitialized",u)},A=function(e){u.disableConfirmPage?(r(".fc-event-clicked").removeClass("fc-event-clicked"),r(this).addClass("fc-event-clicked"),l.doCallback("clickTimeslot",u,e)):C(e)},x=function(n){n=n||t.fullCalendar("getView").name;var i=u.fullCalendar.defaultView,r=420;return e.removeClass("is-small"),e.width()<480&&(r=380,e.addClass("is-small"),u.avatar&&(r-=15),"agendaWeek"!==n&&"basicDay"!==n||(i="basicDay")),console.log(n),console.log(i),u.bookingFields.comment.enabled&&(r+=84),u.bookingFields.phone.enabled&&(r+=64),u.bookingFields.voip.enabled&&(r+=64),u.bookingFields.location.enabled&&(r+=64),u.localization.showTimezoneHelper||(r+=33),{height:r,view:i}},E=function(e){var n=o(e[0].start),i=o(e[0].end),r=i.diff(n,"minutes");r<=90&&t.fullCalendar("option","slotDuration","00:15:00"),t.fullCalendar("addEventSource",{events:e}),t.removeClass("empty-calendar"),u.goToFirstEvent&&y(e[0].start)},T=function(){var t=n(44),i=r(t.render({image:u.avatar}));e.addClass("has-avatar"),e.append(i)},D=function(){var t=n(45),i=r(t.render({name:u.name}));e.addClass("has-displayname"),e.append(i)},C=function(t){l.doCallback("showBookingPage",u,t);var a=n(41),c=n(42),d=u.localization.bookingDateFormat||o.localeData().longDateFormat("LL"),h=u.localization.bookingTimeFormat||o.localeData().longDateFormat("LT");i=r(c.render({chosenDate:o(t.start).format(d),chosenTime:o(t.start).format(h)+" - "+o(t.end).format(h),closeIcon:n(52),checkmarkIcon:n(51),loadingIcon:n(54),errorIcon:n(53),submitText:u.localization.strings.submitText,successMessageTitle:u.localization.strings.successMessageTitle,successMessageBody:s.sprintf(u.localization.strings.successMessageBody,'<span class="booked-email"></span>'),fields:u.bookingFields},{formFields:a}));var f=i.children(".bookingjs-form");i.children(".bookingjs-bookpage-close").click(function(e){e.preventDefault(),_();var t=r(f).hasClass("success");t&&b()}),t.users&&l.logDebug(["Available users for chosen timeslot:",t.users],u),f.submit(function(e){M(this,e,t)}),u.showCredits&&H(i),r(document).on("keyup",function(e){27===e.keyCode&&_()}),e.append(i),setTimeout(function(){i.addClass("show")},100)},_=function(){l.doCallback("closeBookingPage",u),i.removeClass("show"),setTimeout(function(){i.remove()},200),r(document).off("keyup")},M=function(e,t,n){t.preventDefault();var i=r(e);if(i.hasClass("loading")||i.hasClass("success")||i.hasClass("error")||!t.target.checkValidity()){var o=i.find(".bookingjs-form-button");return o.addClass("button-shake"),void setTimeout(function(){o.removeClass("button-shake")},500)}var a={};r.each(i.serializeArray(),function(e,t){a[t.name]=t.value}),i.addClass("loading"),l.doCallback("submitBookingForm",u,a),R(a,n).then(function(e){i.find(".booked-email").html(a.email),i.removeClass("loading").addClass("success")}).catch(function(e){z(i)})},z=function(e){var t=e.find(".bookingjs-form-button");t.addClass("button-shake"),setTimeout(function(){t.removeClass("button-shake")},500),e.removeClass("loading").addClass("error"),setTimeout(function(){e.removeClass("error")},2e3)},R=function(e,t){var n={event:{start:t.start.format(),end:t.end.format(),what:u.name+" x "+e.name,where:"TBD",description:"",calendar_id:u.calendar,participants:[e.email]},customer:{name:e.name,email:e.email,timezone:o.tz.guess()}};if(u.bookingFields.location.enabled&&(n.event.where=e.location),u.bookingFields.comment.enabled&&(n.event.description+=u.bookingFields.comment.placeholder+": "+e.comment+"\n"),u.bookingFields.phone.enabled&&(n.customer.phone=e.phone,n.event.description+=u.bookingFields.phone.placeholder+": "+e.phone+"\n"),u.bookingFields.voip.enabled&&(n.customer.voip=e.voip,n.event.description+=u.bookingFields.voip.placeholder+": "+e.voip+"\n"),r.extend(!0,n,u.timekitCreateBooking),"group_customer"!==u.bookingGraph&&"group_customer_payment"!==u.bookingGraph||(delete n.event,n.related={owner_booking_id:t.booking.id}),t.users){var i=t.users[0],s=r.grep(u.timekitFindTimeTeam.users,function(e){return i.email===e._email});if(s.length<1||!s[0]._calendar)return void l.logError(["Encountered an error when picking designated team user to receive booking",i,u.timekitFindTimeTeam.users]);a=a.asUser(i.email,i.token),n.event.calendar_id=s[0]._calendar,l.logDebug(["Creating booking for user:",i],u)}!t.users&&u.widgetId&&(n.widget_id=u.widgetId),l.doCallback("createBookingStarted",u,n);var c={"Timekit-OutputTimestampFormat":"Y-m-d "+u.localization.emailTimeFormat+" (P e)"},d=a.include("attributes","event","user").headers(c).createBooking(n);return d.then(function(e){l.doCallback("createBookingSuccessful",u,e)}).catch(function(e){l.logError(["An error with Timekit CreateBooking occured, context:",e]),l.doCallback("createBookingFailed",u,e)}),d},H=function(e){var t="widget",i=window.location.hostname.replace(/\./g,"-");u.widgetId&&(t="embedded-widget"),u.widgetSlug&&(t="hosted-widget");var o=n(43),a=n(55),s=r(o.render({timekitLogo:a,campaignName:t,campaignSource:i}));e.append(s)},L=function(e){return r.extend(!0,{},c.primary,e)},O=function(e,t,n){var i=c.presets[t][n];return i?r.extend(!0,{},e,i):e},P=function(e){(void 0===e||"object"!=typeof e||r.isEmptyObject(e))&&l.logError("No configuration was supplied or found. Please supply a config object upon library initialization");var t=L(e);return t=O(t,"timeDateFormat",t.localization.timeDateFormat),t=O(t,"bookingGraph",t.bookingGraph),t=O(t,"availabilityView",t.availabilityView),t.email||l.logError('A required config setting ("email") was missing'),t.apiToken||l.logError('A required config setting ("apiToken") was missing'),t.calendar||"group_customer"===t.bookingGraph||"group_customer_payment"===t.bookingGraph||t.timekitFindTimeTeam||l.logError('A required config setting ("calendar") was missing'),u=t},I=function(){return u},j=function(){return"1.13.0"},N=function(){return l.doCallback("renderStarted",u),d(),h(),f(),p(),S(),b(),u.localization.showTimezoneHelper&&k(),u.avatar&&T(),u.name&&D(),l.doCallback("renderCompleted",u),this},F=function(e){return!e.widgetId&&!e.widgetSlug||e.disableRemoteLoad?G(e):B(e).then(function(t){var n=t.data.config;t.data.id&&(n.widgetId=t.data.id);var i=r.extend(!0,{},n,e);G(i)})},B=function(e){return u=L(e),f(),e.widgetId?a.getEmbedWidget({id:e.widgetId}).catch(function(){l.logError("The widget could not be found, please double-check your widgetId")}):e.widgetSlug?a.getHostedWidget({slug:e.widgetSlug}).catch(function(){l.logError("The widget could not be found, please double-check your widgetSlug")}):void l.logError("No widget configuration, widgetSlug or widgetId found")},G=function(e){return P(e),N()},Y=function(){return h(),u={},this},W=function(){if(void 0!==t.fullCalendar)return t.fullCalendar.apply(t,arguments)};return{setConfig:P,getConfig:I,getVersion:j,render:N,init:F,destroy:Y,timekitCreateBooking:R,fullCalendar:W,timekitSdk:a}}/*!
	 * Booking.js
	 * http://timekit.io
	 *
