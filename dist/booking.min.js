!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof exports?exports.TimekitBooking=t(require("jquery")):e.TimekitBooking=t(e.jQuery)}(this,function(e){return function(e){function t(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return e[i].call(r.exports,r,r.exports,t),r.loaded=!0,r.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function i(){var e,t,i,u,d,h=a.newInstance(),f={},p=function(t){var n=t.targetEl||f.targetEl||c.primary.targetEl;if(e=r(n),0===e.length)throw I("No target DOM element was found ("+n+")");e.addClass("bookingjs"),e.children(":not(script)").remove()},g=function(){h.configure(f.timekitConfig)},m=function(){h.setUser(f.email,f.apiToken)},v=function(){var e={};f.timekitFindTime.calendar_ids||f.timekitFindTime.user_ids||(e.emails=[f.email]),r.extend(e,f.timekitFindTime),l.doCallback("findTimeStarted",f,e),h.findTime(e).then(function(e){l.doCallback("findTimeSuccessful",f,e),R(),e.data.length>0&&M(e.data)}).catch(function(e){l.doCallback("findTimeFailed",f,e),R(),I(["An error with Timekit FindTime occured",e])})},b=function(){var e={url:"/findtime/team",method:"post",data:f.timekitFindTimeTeam};r.each(f.timekitFindTimeTeam.users,function(e,t){r.extend(t,f.timekitFindTime),t.calendar_ids||t.user_ids||(t.emails=[t._email])}),l.doCallback("findTimeTeamStarted",f,e),h.makeRequest(e).then(function(e){l.doCallback("findTimeTeamSuccessful",f,e),R(),e.data.length>0&&M(e.data)}).catch(function(e){l.doCallback("findTimeTeamFailed",f,e),R(),I(["An error with Timekit FindTimeTeam occured",e])})},y=function(){l.doCallback("GetBookingSlotsStarted",f);var e={url:"/bookings/groups",method:"get"};f.widgetId&&(e.params={search:"widget.id:"+f.widgetId}),h.makeRequest(e).then(function(e){var t=e.data.map(function(e){return{title:e.attributes.event_info.what,start:e.attributes.event_info.start,end:e.attributes.event_info.end,booking:e}});l.doCallback("getBookingSlotsSuccessful",f,e),R(),t.length>0&&M(t)}).catch(function(e){l.doCallback("getBookingSlotsFailed",f,e),R(),I(["An error with Timekit GetBookings occured",e])})},w=function(){z(),t.fullCalendar("removeEventSources"),"group_customer"===f.bookingGraph||"group_customer_payment"===f.bookingGraph?y():f.timekitFindTimeTeam?b():v()},k=function(e){t.fullCalendar("gotoDate",e);var n=s(e).format("H");A(n)},A=function(e){if("agendaWeek"===t.fullCalendar("getView").name){var n=t.fullCalendar("option","slotDuration"),i=30;n&&(i=n.slice(3,5));var o=t.find(".fc-slats .fc-minor"),a=r(o[0]).height()*(60/i),l=0;if(f.fullCalendar.minTime){var c=s(f.fullCalendar.minTime,"HH:mm:ss").format("H");l=a*c}var u=a*e-l,d=t.find(".fc-scroller"),h=d.height(),p=d.scrollTop(),g=d.find(".fc-time-grid").height();u>p&&u<p+h||(u>g-h&&(u=g-h),d.animate({scrollTop:u}))}},S=function(){var t=n(50),i=r(t.render({ribbonText:"Test Mode"}));e.addClass("has-testmoderibbon"),e.append(i)},D=function(){var t=s().utcOffset()/60,i=n(64),a=n(11),c=r(a.render({timezoneIcon:i,loadingText:f.localization.strings.timezoneHelperLoading,loading:!0}));e.addClass("has-timezonehelper"),e.append(c);var u={email:f.email};l.doCallback("getUserTimezoneStarted",f,u),h.getUserTimezone(u).then(function(e){l.doCallback("getUserTimezoneSuccessful",f,e);var a=e.data.utc_offset,s=t-a,u=Math.abs(t-a),d=s>0?"ahead of":"behind",h=n(11),p=r(h.render({timezoneIcon:i,timezoneDifference:0!==u,timezoneDifferent:o.sprintf(f.localization.strings.timezoneHelperDifferent,u,d,f.name),timezoneSame:o.sprintf(f.localization.strings.timezoneHelperSame,f.name)}));c.replaceWith(p)}).catch(function(e){l.doCallback("getUserTimezoneFailed",f,e),l.logError(["An error with Timekit getUserTimezone occured",e])})},x=function(){var n=T(f.fullCalendar.defaultView),i={height:n.height,eventClick:E,windowResize:function(){var e=T();t.fullCalendar("changeView",e.view),t.fullCalendar("option","height",e.height)}};r.extend(!0,i,f.fullCalendar),i.defaultView=n.view,t=r('<div class="bookingjs-calendar empty-calendar">'),e.append(t),t.fullCalendar(i),l.doCallback("fullCalendarInitialized",f)},E=function(e){f.disableConfirmPage?(r(".fc-event-clicked").removeClass("fc-event-clicked"),r(this).addClass("fc-event-clicked"),l.doCallback("clickTimeslot",f,e)):P(e)},T=function(n){n=n||t.fullCalendar("getView").name;var i=f.fullCalendar.defaultView,r=430;return e.width()<480?(r=390,e.addClass("is-small"),f.avatar&&(r-=15),"agendaWeek"!==n&&"basicDay"!==n||(i="basicDay")):e.removeClass("is-small"),f.bookingFields.comment.enabled&&(r+=100),f.bookingFields.phone.enabled&&(r+=64),f.bookingFields.voip.enabled&&(r+=64),f.bookingFields.location.enabled&&(r+=64),f.localization.showTimezoneHelper||(r+=33),{height:r,view:i}},M=function(e){var n=s(e[0].start),i=s(e[0].end),r=i.diff(n,"minutes");r<=90&&t.fullCalendar("option","slotDuration","00:15:00"),t.fullCalendar("addEventSource",{events:e}),t.removeClass("empty-calendar"),f.goToFirstEvent&&k(e[0].start)},C=function(){var t=n(51),i=r(t.render({image:f.avatar}));e.addClass("has-avatar"),e.append(i)},_=function(){var t=n(52),i=r(t.render({name:f.name}));e.addClass("has-displayname"),e.append(i)},z=function(){l.doCallback("showLoadingScreen",f);var t=n(48);u=r(t.render({loadingIcon:n(12)})),e.append(u)},R=function(){l.doCallback("hideLoadingScreen",f),u.removeClass("show"),setTimeout(function(){u.remove()},500)},I=function(t){if(d)return t;if(l.doCallback("errorTriggered",t),l.logError(t),!e)return t;var i=t,o=null;l.isArray(t)&&(i=t[0],o=t[1].data?JSON.stringify(t[1].data.errors||t[1].data.error||t[1].data):JSON.stringify(t[1]));var a=n(47);return d=r(a.render({errorWarningIcon:n(62),message:i,context:o})),e.append(d),t},P=function(t){l.doCallback("showBookingPage",f,t);var a=n(45),c=n(46),u=f.localization.bookingDateFormat||s.localeData().longDateFormat("LL"),d=f.localization.bookingTimeFormat||s.localeData().longDateFormat("LT");i=r(c.render({chosenDate:s(t.start).format(u),chosenTime:s(t.start).format(d)+" - "+s(t.end).format(d),closeIcon:n(60),checkmarkIcon:n(59),loadingIcon:n(12),errorIcon:n(61),submitText:f.localization.strings.submitText,successMessageTitle:f.localization.strings.successMessageTitle,successMessageBody:o.sprintf(f.localization.strings.successMessageBody,'<span class="booked-email"></span>'),fields:f.bookingFields},{formFields:a}));var h=i.children(".bookingjs-form");i.children(".bookingjs-bookpage-close").click(function(e){e.preventDefault();var t=r(h).hasClass("success");t&&w(),H()}),t.users&&l.logDebug(["Available users for chosen timeslot:",t.users],f),h.find(".bookingjs-form-input").on("input",function(){var e=r(this).closest(".bookingjs-form-field");this.value?e.addClass("bookingjs-form-field--dirty"):e.removeClass("bookingjs-form-field--dirty")}),h.submit(function(e){L(this,e,t)}),f.showCredits&&j(i),r(document).on("keyup",function(e){27===e.keyCode&&H()}),e.append(i),setTimeout(function(){i.addClass("show")},100)},H=function(){l.doCallback("closeBookingPage",f),i.removeClass("show"),setTimeout(function(){i.remove()},200),r(document).off("keyup")},L=function(e,t,n){t.preventDefault();var i=r(e);if(i.hasClass("success"))return w(),void H();if(i.hasClass("loading")||i.hasClass("error")||!t.target.checkValidity()){var o=i.find(".bookingjs-form-button");return o.addClass("button-shake"),void setTimeout(function(){o.removeClass("button-shake")},500)}var a={};r.each(i.serializeArray(),function(e,t){a[t.name]=t.value}),i.addClass("loading"),l.doCallback("submitBookingForm",f,a),O(a,n).then(function(e){i.find(".booked-email").html(a.email),i.removeClass("loading").addClass("success")}).catch(function(e){F(i)})},F=function(e){var t=e.find(".bookingjs-form-button");t.addClass("button-shake"),setTimeout(function(){t.removeClass("button-shake")},500),e.removeClass("loading").addClass("error"),setTimeout(function(){e.removeClass("error")},2e3)},O=function(e,t){var n={event:{start:t.start.format(),end:t.end.format(),what:f.name+" x "+e.name,where:"TBD",description:"",calendar_id:f.calendar,participants:[e.email]},customer:{name:e.name,email:e.email,timezone:s.tz.guess()}};if(f.bookingFields.location.enabled&&(n.event.where=e.location),f.bookingFields.comment.enabled&&(n.event.description+=f.bookingFields.comment.placeholder+": "+e.comment+"\n"),f.bookingFields.phone.enabled&&(n.customer.phone=e.phone,n.event.description+=f.bookingFields.phone.placeholder+": "+e.phone+"\n"),f.bookingFields.voip.enabled&&(n.customer.voip=e.voip,n.event.description+=f.bookingFields.voip.placeholder+": "+e.voip+"\n"),r.extend(!0,n,f.timekitCreateBooking),"group_customer"!==f.bookingGraph&&"group_customer_payment"!==f.bookingGraph||(delete n.event,n.related={owner_booking_id:t.booking.id}),t.users){var i=t.users[0],o=r.grep(f.timekitFindTimeTeam.users,function(e){return i.email===e._email});if(o.length<1||!o[0]._calendar)throw I(["Encountered an error when picking designated team user to receive booking",i,f.timekitFindTimeTeam.users]);h=h.asUser(i.email,i.token),n.event.calendar_id=o[0]._calendar,l.logDebug(["Creating booking for user:",i],f)}!t.users&&f.widgetId&&(n.widget_id=f.widgetId),l.doCallback("createBookingStarted",f,n);var a={"Timekit-OutputTimestampFormat":"Y-m-d "+f.localization.emailTimeFormat+" (P e)"},c=h.include("attributes","event","user").headers(a).createBooking(n);return c.then(function(e){l.doCallback("createBookingSuccessful",f,e)}).catch(function(e){l.doCallback("createBookingFailed",f,e),I(["An error with Timekit CreateBooking occured",e])}),c},j=function(e){var t="widget",i=window.location.hostname.replace(/\./g,"-");f.widgetId&&(t="embedded-widget"),f.widgetSlug&&(t="hosted-widget");var o=n(49),a=n(63),s=r(o.render({timekitLogo:a,campaignName:t,campaignSource:i}));e.append(s)},B=function(e){return r.extend(!0,{},c.primary,e)},N=function(e,t,n){var i=c.presets[t][n];return i?r.extend(!0,{},i,e):e},G=function(e){if(void 0===e||"object"!=typeof e||r.isEmptyObject(e))throw I("No configuration was supplied or found. Please supply a config object upon library initialization");var t=B(e);if(e.app&&(t.timekitConfig.app=e.app),t=N(t,"timeDateFormat",t.localization.timeDateFormat),t=N(t,"bookingGraph",t.bookingGraph),t=N(t,"availabilityView",t.availabilityView),!t.app&&!t.timekitConfig.app)throw I('A required config setting ("app") was missing');if(!t.email)throw I('A required config setting ("email") was missing');if(!t.apiToken)throw I('A required config setting ("apiToken") was missing');if(!t.calendar&&"group_customer"!==t.bookingGraph&&"group_customer_payment"!==t.bookingGraph&&!t.timekitFindTimeTeam)throw I('A required config setting ("calendar") was missing');return f=t,l.logDebug(["Final config:",f],f),l.logDebug(["Version:",W()],f),f},Y=function(){return f},W=function(){return"1.18.1"},V=function(){return l.doCallback("renderStarted",f),g(),m(),x(),w(),f.localization.showTimezoneHelper&&D(),f.avatar&&C(),f.name&&_(),S(),l.doCallback("renderCompleted",f),this},U=function(e){l.logDebug(["Supplied config:",e],e);try{if(p(e||{}),!e||!e.widgetId&&!e.widgetSlug||e.disableRemoteLoad)return Z(e)}catch(e){return this}return q(e).then(function(t){var n=t.data.config;t.data.id&&(n.widgetId=t.data.id);var i=r.extend(!0,{},n,e);l.logDebug(["Remote config:",n],i),Z(i)}).catch(function(){I("The widget could not be found, please double-check your widgetId/widgetSlug")}),this},q=function(e){if(f=B(e),g(),e.widgetId)return h.getEmbedWidget({id:e.widgetId});if(e.widgetSlug)return h.getHostedWidget({slug:e.widgetSlug});throw I("No widget configuration, widgetSlug or widgetId found")},Z=function(e){return G(e),V()},X=function(){return p({}),f={},this},J=function(){if(void 0!==t.fullCalendar)return t.fullCalendar.apply(t,arguments)};return{setConfig:G,getConfig:Y,getVersion:W,render:V,init:U,destroy:X,timekitCreateBooking:O,fullCalendar:J,timekitSdk:h}}/*!
	 * Booking.js
	 * http://timekit.io
	 *
