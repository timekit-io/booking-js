!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof exports?exports.TimekitBooking=t(require("jquery")):e.TimekitBooking=t(e.jQuery)}(this,function(e){return function(e){function t(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return e[i].call(r.exports,r,r.exports,t),r.loaded=!0,r.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function i(){var e,t,i,u,d,h=s.newInstance(),f={},p=function(t){var n=t.targetEl||f.targetEl||c.primary.targetEl;if(e=r(n),0===e.length)throw R("No target DOM element was found ("+n+")");e.addClass("bookingjs"),e.children(":not(script)").remove()},g=function(){h.configure(f.timekitConfig)},m=function(){h.setUser(f.email,f.apiToken)},v=function(){var e={};r.extend(e,f.timekitFindTime),l.doCallback("findTimeStarted",f,e),h.makeRequest({method:"post",url:"/availability",data:r.extend({},{project_id:f.projectId},f.availability)}).then(function(e){l.doCallback("findTimeSuccessful",f,e),z(),e.data.length>0&&T(e.data),e.headers["timekit-testmode"]&&S()}).catch(function(e){l.doCallback("findTimeFailed",f,e),z(),R(["An error with Timekit FindTime occured",e])})},b=function(){l.doCallback("GetBookingSlotsStarted",f);var e={url:"/bookings/groups",method:"get"};f.widgetId&&(e.params={search:"widget.id:"+f.widgetId}),h.makeRequest(e).then(function(e){var t=e.data.map(function(e){return{title:e.attributes.event_info.what,start:e.attributes.event_info.start,end:e.attributes.event_info.end,booking:e}});t.sort(function(e,t){return a(e.start)-a(t.start)}),l.doCallback("getBookingSlotsSuccessful",f,e),z(),t.length>0&&T(t),e.headers["timekit-testmode"]&&S()}).catch(function(e){l.doCallback("getBookingSlotsFailed",f,e),z(),R(["An error with Timekit GetBookings occured",e])})},y=function(){_(),t.fullCalendar("removeEventSources"),"group_customer"===f.bookingGraph||"group_customer_payment"===f.bookingGraph?b():v()},w=function(e){t.fullCalendar("gotoDate",e);var n=a(e).format("H");k(n)},k=function(e){if("agendaWeek"===t.fullCalendar("getView").name){var n=t.fullCalendar("option","slotDuration"),i=30;n&&(i=n.slice(3,5));var o=t.find(".fc-slats .fc-minor"),s=r(o[0]).height()*(60/i),l=0;if(f.fullCalendar.minTime){var c=a(f.fullCalendar.minTime,"HH:mm:ss").format("H");l=s*c}var u=s*e-l,d=t.find(".fc-scroller"),h=d.height(),p=d.scrollTop(),g=d.find(".fc-time-grid").height();u>p&&u<p+h||(u>g-h&&(u=g-h),d.animate({scrollTop:u}))}},A=function(){var t=a().utcOffset()/60,i=n(65),s=n(11),c=r(s.render({timezoneIcon:i,loadingText:f.localization.strings.timezoneHelperLoading,loading:!0}));e.addClass("has-timezonehelper"),e.append(c);var u={email:f.email};l.doCallback("getUserTimezoneStarted",f,u),h.getUserTimezone(u).then(function(e){l.doCallback("getUserTimezoneSuccessful",f,e);var s=e.data.utc_offset,a=t-s,u=Math.abs(t-s),d=a>0?"ahead of":"behind",h=n(11),p=r(h.render({timezoneIcon:i,timezoneDifference:0!==u,timezoneDifferent:o.sprintf(f.localization.strings.timezoneHelperDifferent,u,d,f.name),timezoneSame:o.sprintf(f.localization.strings.timezoneHelperSame,f.name)}));c.replaceWith(p)}).catch(function(e){l.doCallback("getUserTimezoneFailed",f,e),l.logError(["An error with Timekit getUserTimezone occured",e])})},S=function(){var t=n(51),i=r(t.render({ribbonText:"Test Mode"}));e.append(i)},D=function(){var n=E(f.fullCalendar.defaultView),i={height:n.height,eventClick:x,windowResize:function(){var e=E();t.fullCalendar("changeView",e.view),t.fullCalendar("option","height",e.height)}};r.extend(!0,i,f.fullCalendar),i.defaultView=n.view,t=r('<div class="bookingjs-calendar empty-calendar">'),e.append(t),t.fullCalendar(i),l.doCallback("fullCalendarInitialized",f)},x=function(e){f.disableConfirmPage?(r(".fc-event-clicked").removeClass("fc-event-clicked"),r(this).addClass("fc-event-clicked"),l.doCallback("clickTimeslot",f,e)):P(e)},E=function(n){n=n||t.fullCalendar("getView").name;var i=f.fullCalendar.defaultView,r=430;return e.width()<480?(r=390,e.addClass("is-small"),f.avatar&&(r-=15),"agendaWeek"!==n&&"basicDay"!==n||(i="basicDay")):e.removeClass("is-small"),f.bookingFields.comment.enabled&&(r+=100),f.bookingFields.phone.enabled&&(r+=64),f.bookingFields.voip.enabled&&(r+=64),f.bookingFields.location.enabled&&(r+=64),f.localization.showTimezoneHelper||(r+=33),{height:r,view:i}},T=function(e){var n=a(e[0].start),i=a(e[0].end),r=i.diff(n,"minutes");r<=90&&t.fullCalendar("option","slotDuration","00:15:00"),t.fullCalendar("addEventSource",{events:e}),t.removeClass("empty-calendar"),f.goToFirstEvent&&w(e[0].start)},M=function(){var t=n(52),i=r(t.render({image:f.avatar}));e.addClass("has-avatar"),e.append(i)},C=function(){var t=n(53),i=r(t.render({name:f.name}));e.addClass("has-displayname"),e.append(i)},_=function(){l.doCallback("showLoadingScreen",f);var t=n(49);u=r(t.render({loadingIcon:n(12)})),e.append(u)},z=function(){l.doCallback("hideLoadingScreen",f),u.removeClass("show"),setTimeout(function(){u.remove()},500)},R=function(t){if(d)return t;if(l.doCallback("errorTriggered",t),l.logError(t),!e)return t;var i=t,o=null;l.isArray(t)&&(i=t[0],o=t[1].data?JSON.stringify(t[1].data.errors||t[1].data.error||t[1].data):JSON.stringify(t[1]));var s=n(48);return d=r(s.render({errorWarningIcon:n(63),message:i,context:o})),e.append(d),t},P=function(t){l.doCallback("showBookingPage",f,t);var s=n(46),c=n(47),u=f.localization.bookingDateFormat||a.localeData().longDateFormat("LL"),d=f.localization.bookingTimeFormat||a.localeData().longDateFormat("LT"),h=!!t.users&&t.users[0].name;i=r(c.render({chosenDate:a(t.start).format(u),chosenTime:a(t.start).format(d)+" - "+a(t.end).format(d),allocatedResourcePrefix:f.localization.strings.allocatedResourcePrefix,allocatedResource:h,closeIcon:n(61),checkmarkIcon:n(60),loadingIcon:n(12),errorIcon:n(62),submitText:f.localization.strings.submitText,successMessageTitle:f.localization.strings.successMessageTitle,successMessageBody:o.sprintf(f.localization.strings.successMessageBody,'<span class="booked-email"></span>'),fields:f.bookingFields},{formFields:s}));var p=i.children(".bookingjs-form");i.children(".bookingjs-bookpage-close").click(function(e){e.preventDefault();var t=r(p).hasClass("success");t&&y(),I()}),t.users&&l.logDebug(["Available users for chosen timeslot:",t.users],f),p.find(".bookingjs-form-input").on("input",function(){var e=r(this).closest(".bookingjs-form-field");this.value?e.addClass("bookingjs-form-field--dirty"):e.removeClass("bookingjs-form-field--dirty")}),p.submit(function(e){H(this,e,t)}),f.showCredits&&j(i),r(document).on("keyup",function(e){27===e.keyCode&&I()}),e.append(i),setTimeout(function(){i.addClass("show")},100)},I=function(){l.doCallback("closeBookingPage",f),i.removeClass("show"),setTimeout(function(){i.remove()},200),r(document).off("keyup")},H=function(e,t,n){t.preventDefault();var i=r(e);if(i.hasClass("success"))return y(),void I();if(i.hasClass("loading")||i.hasClass("error")||!t.target.checkValidity()){var o=i.find(".bookingjs-form-button");return o.addClass("button-shake"),void setTimeout(function(){o.removeClass("button-shake")},500)}var s={};r.each(i.serializeArray(),function(e,t){s[t.name]=t.value}),i.addClass("loading"),l.doCallback("submitBookingForm",f,s),O(s,n).then(function(e){i.find(".booked-email").html(s.email),i.removeClass("loading").addClass("success")}).catch(function(e){L(i)})},L=function(e){var t=e.find(".bookingjs-form-button");t.addClass("button-shake"),setTimeout(function(){t.removeClass("button-shake")},500),e.removeClass("loading").addClass("error"),setTimeout(function(){e.removeClass("error")},2e3)},O=function(e,t){var n={event:{start:t.start.format(),end:t.end.format(),what:f.name+" x "+e.name,where:"TBD",description:"",participants:[e.email]},customer:{name:e.name,email:e.email,timezone:a.tz.guess()}};f.calendar&&(n.event.calendar_id=f.calendar),f.bookingFields.location.enabled&&(n.customer.where=e.location,n.event.where=e.location),f.bookingFields.comment.enabled&&(n.customer.comment=e.comment,n.event.description+=f.bookingFields.comment.placeholder+": "+e.comment+"\n"),f.bookingFields.phone.enabled&&(n.customer.phone=e.phone,n.event.description+=f.bookingFields.phone.placeholder+": "+e.phone+"\n"),f.bookingFields.voip.enabled&&(n.customer.voip=e.voip,n.event.description+=f.bookingFields.voip.placeholder+": "+e.voip+"\n"),r.extend(!0,n,f.booking),"group_customer"!==f.bookingGraph&&"group_customer_payment"!==f.bookingGraph||(delete n.event,n.related={owner_booking_id:t.booking.id}),n.resource_id=t.resources[0],f.projectId&&(n.project_id=f.projectId),l.doCallback("createBookingStarted",f,n);var i={"Timekit-OutputTimestampFormat":"Y-m-d "+f.localization.emailTimeFormat+" (P e)"},o=h.include("attributes","event","user").headers(i).createBooking(n);return o.then(function(e){l.doCallback("createBookingSuccessful",f,e)}).catch(function(e){l.doCallback("createBookingFailed",f,e),R(["An error with Timekit CreateBooking occured",e])}),o},j=function(e){var t="widget",i=window.location.hostname.replace(/\./g,"-");f.widgetId&&(t="embedded-widget"),f.widgetSlug&&(t="hosted-widget");var o=n(50),s=n(64),a=r(o.render({timekitLogo:s,campaignName:t,campaignSource:i}));e.append(a)},F=function(e){return e.appToken&&(e.timekitConfig.appToken=e.appToken),r.extend(!0,{},c.primary,e)},B=function(e,t,n){var i=c.presets[t][n];return i?r.extend(!0,{},i,e):e},N=function(e){if(void 0===e||"object"!=typeof e||r.isEmptyObject(e))throw R("No configuration was supplied or found. Please supply a config object upon library initialization");var t=F(e);if(t=B(t,"timeDateFormat",t.localization.timeDateFormat),t=B(t,"bookingGraph",t.bookingGraph),t=B(t,"availabilityView",t.availabilityView),!t.appToken)throw R('A required config setting ("appToken") was missing');return t.id&&(t.projectId=t.id,delete t.id),f=t,l.logDebug(["Final config:",f],f),l.logDebug(["Version:",G()],f),f},Y=function(){return f},G=function(){return"1.24.2"},W=function(){return l.doCallback("renderStarted",f),g(),m(),D(),y(),f.localization.showTimezoneHelper&&A(),f.avatar&&M(),f.name&&C(),l.doCallback("renderCompleted",f),this},U=function(e){l.logDebug(["Supplied config:",e],e);try{if(p(e||{}),!e||!e.projectId&&!e.widgetSlug||e.disableRemoteLoad)return V(e)}catch(e){return this}return q(e).then(function(t){var n=t.data;t.data.id&&(n.projectId=t.data.id);var i=r.extend(!0,{},n,e);l.logDebug(["Remote config:",n],i),V(i)}).catch(function(){R("The project could not be found, please double-check your projectId/projectSlug")}),this},q=function(e){if(f=F(e),g(),e.projectId&&e.appToken)return h.makeRequest({url:"/projects/embed/"+e.projectId,method:"get"});if(e.widgetSlug)return h.makeRequest({url:"/projects/hosted/"+e.projectSlug,method:"get"});throw R("No widget configuration, widgetSlug or widgetId found")},V=function(e){return N(e),W()},Z=function(){return p({}),f={},this},X=function(){if(void 0!==t.fullCalendar)return t.fullCalendar.apply(t,arguments)};return{setConfig:N,getConfig:Y,getVersion:G,render:W,init:U,destroy:Z,timekitCreateBooking:O,fullCalendar:X,timekitSdk:h}}/*!
	 * Booking.js
	 * http://timekit.io
	 *
