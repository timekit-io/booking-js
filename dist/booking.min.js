!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof exports?exports.TimekitBooking=t(require("jquery")):e.TimekitBooking=t(e.jQuery)}(this,function(e){return function(e){function t(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return e[i].call(r.exports,r,r.exports,t),r.loaded=!0,r.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function i(){var e=l.instance,t=function(e){var t=s.setDefaults(e);s.update(t),o.logDebug(["Supplied config:",e]),o.logDebug(a);try{if(a.prepareDOM(e||{}),!e||!e.projectId&&!e.projectSlug||e.disableRemoteLoad)return i(e)}catch(e){return o.logError(e),this}return n(e).then(function(t){var n=t.data;n.id&&(n.projectId=n.id,delete n.id),n.app_key&&(n.appKey=n.app_key,delete n.app_key);var s=r.extend(!0,{},n,e);o.logDebug(["Remote config:",n]),i(s)}).catch(function(){a.triggerError("The project could not be found, please double-check your projectId/projectSlug")}),this},n=function(t){var n=s.setDefaults(t);if(s.update(n),l.timekitSetupConfig(),t.projectId&&t.appKey)return e.makeRequest({url:"/projects/embed/"+t.projectId,method:"get"});if(t.projectSlug)return e.makeRequest({url:"/projects/hosted/"+t.projectSlug,method:"get"});throw a.triggerError("No widget configuration, projectSlug or projectId found")},i=function(e){try{s.parseAndUpdate(e),o.logDebug(["Final config:",s.retrieve()]),o.logDebug(["Version:",u()])}catch(e){return a.triggerError(e),this}return c()},c=function(){return o.doCallback("renderStarted"),l.timekitSetupConfig(),a.initializeCalendar(),a.getAvailability(),s.retrieve().localization.showTimezoneHelper,s.retrieve().avatar&&a.renderAvatarImage(),s.retrieve().name&&a.renderDisplayName(),o.doCallback("renderCompleted"),this},u=function(){return"1.24.2"},d=function(){return a.prepareDOM({}),s.update({}),this};return{setConfig:s.parseAndUpdate,getConfig:s.retrieve,getVersion:u,render:a,init:t,destroy:d,timekitCreateBooking:a.timekitCreateBooking,fullCalendar:a.fullCalendar,timekitSdk:e}}/*!
	 * Booking.js
	 * http://timekit.io
	 *
...
return e.makeRequest({url:"/resources",method:"post",data:t})},e.updateResource=function(t){var n=t.id;return delete t.id,e.makeRequest({url:"/resources/"+n,method:"put",data:t})},e.resetResourcePassword=function(t){return e.makeRequest({url:"/resources/resetpassword",method:"post",data:t})},e.getResourceTimezone=function(t){return e.makeRequest({url:"/resources/timezone/"+t.email,method:"get"})},e.getCalendars=function(){return e.makeRequest({url:"/calendars",method:"get"})},e.getCalendar=function(t){return e.makeRequest({url:"/calendars/"+t.id,method:"get"})},e.createCalendar=function(t){return e.makeRequest({url:"/calendars/",method:"post",data:t})},e.updateCalendar=function(t){var n=t.id;return delete t.id,e.makeRequest({url:"/calendars/"+n,method:"put",data:t})},e.deleteCalendar=function(t){return e.makeRequest({url:"/calendars/"+t.id,method:"delete"})},e.getEvents=function(t){return e.makeRequest({url:"/events",method:"get",params:t})},e.getEvent=function(t){return e.makeRequest({url:"/events/"+t.id,method:"get"})},e.createEvent=function(t){return e.makeRequest({url:"/events",method:"post",data:t})},e.updateEvent=function(t){var n=t.id;return delete t.id,e.makeRequest({url:"/events/"+n,method:"put",data:t})},e.deleteEvent=function(t){return e.makeRequest({url:"/events/"+t.id,method:"delete"})},e.findTime=function(t){return e.makeRequest({url:"/findtime",method:"post",data:t})},e.findTimeBulk=function(t){return e.makeRequest({url:"/findtime/bulk",method:"post",data:t})},e.findTimeTeam=function(t){return e.makeRequest({url:"/findtime/team",method:"post",data:t})},e.getCredentials=function(){return e.makeRequest({url:"/credentials",method:"get"})},e.createCredential=function(t){return e.makeRequest({url:"/credentials",method:"post",data:t})},e.deleteCredential=function(t){return e.makeRequest({url:"/credentials/"+t.id,method:"delete"})},e.getBookings=function(){return e.makeRequest({url:"/bookings",method:"get"})},e.getBooking=function(t){return e.makeRequest({url:"/bookings/"+t.id,method:"get"})},e.createBooking=function(t){return e.makeRequest({url:"/bookings",method:"post",data:t})},e.createBookingsBulk=function(t){return e.makeRequest({url:"/bookings/bulk",method:"post",data:t})},e.updateBooking=function(t){var n=t.id;delete t.id;var i=t.action;return delete t.action,e.makeRequest({url:"/bookings/"+n+"/"+i,method:"put",data:t})},e.updateBookingsBulk=function(t){return e.makeRequest({url:"/bookings/bulk",method:"put",data:t})},e.getGroupBookings=function(){return e.makeRequest({url:"/bookings/groups",method:"get"})},e.getGroupBooking=function(t){return e.makeRequest({url:"/bookings/"+t.id+"/groups",method:"get"})},e.getWidgets=function(){return e.makeRequest({url:"/widgets",method:"get"})},e.getWidget=function(t){return e.makeRequest({url:"/widgets/"+t.id,method:"get"})},e.getHostedWidget=function(t){return e.makeRequest({url:"/widgets/hosted/"+t.slug,method:"get"})},e.getEmbedWidget=function(t){return e.makeRequest({url:"/widgets/embed/"+t.id,method:"get"})},e.createWidget=function(t){return e.makeRequest({url:"/widgets",method:"post",data:t})},e.updateWidget=function(t){var n=t.id;return delete t.id,e.makeRequest({url:"/widgets/"+n,method:"put",data:t})},e.deleteWidget=function(t){return e.makeRequest({url:"/widgets/"+t.id,method:"delete"})},e}},function(e,t,n){(function(t){"use strict";function i(){var e=[],n={},u={},d={app:"",apiBaseUrl:"https://api.timekit.io/",apiVersion:"v2",convertResponseToCamelcase:!1,convertRequestToSnakecase:!0,autoFlattenResponse:!0,resourceEmail:null,resourceKey:null,appKey:null},h={};return h.makeRequest=function(i){i=a.mergeNextPayload(i,u),u={},i.url=a.buildUrl(i.url,d),i.headers=i.headers||n||{},d.headers&&(i.headers=s(d.headers,i.headers)),!i.headers["Timekit-App"]&&d.app&&(i.headers["Timekit-App"]=d.app),d.inputTimestampFormat&&(i.headers["Timekit-InputTimestampFormat"]=d.inputTimestampFormat),d.outputTimestampFormat&&(i.headers["Timekit-OutputTimestampFormat"]=d.outputTimestampFormat),d.timezone&&(i.headers["Timekit-Timezone"]=d.timezone),!i.headers.Authorization&&d.resourceEmail&&d.resourceKey&&(i.headers.Authorization="Basic "+a.encodeAuthHeader(d.resourceEmail,d.resourceKey)),!i.headers.Authorization&&d.appKey&&(i.headers.Authorization="Basic "+a.encodeAuthHeader("",d.appKey)),Object.keys(n).length>0&&(n={}),e&&e.length>0&&(void 0===i.params&&(i.params={}),i.params.include=e.join(),e=[]),i.data&&d.convertRequestToSnakecase&&(i.data=o.decamelizeKeys(i.data));var l=r.interceptors.response.use(function(e){return e.data&&e.data.data&&(d.autoFlattenResponse&&(e=a.copyResponseMetaData(e)),d.convertResponseToCamelcase&&(e.data=o.camelizeKeys(e.data))),e},function(e){return t.reject(e)}),c=r(i);return r.interceptors.response.eject(l),c},h.configure=function(e){for(var t in e)d[t]=e[t];return d},h.getConfig=function(){return d},h.setUser=function(e,t){d.resourceEmail=e,d.resourceKey=t},h.getUser=function(){return{email:d.resourceEmail,apiToken:d.resourceKey}},h.setAppKey=function(e){d.appKey=e},h.getAppKey=function(){return d.appKey},h.asUser=function(e,t){return n.Authorization="Basic "+a.encodeAuthHeader(e,t),this},h.asApp=function(e){return n["Timekit-App"]=e,this},h.include=function(){return e=Array.prototype.slice.call(arguments),this},h.headers=function(e){return n=s(n,e),this},h.carry=function(e){return u=s(u,e),this},h.newInstance=function(){return new i},h.accountGoogleSignup=function(e,t){var i=d.app;n["Timekit-App"]&&(i=n["Timekit-App"]);var r=a.buildUrl("/accounts/google/signup",d),o=r+"?Timekit-App="+i+(e&&e.callback?"&callback="+e.callback:"");return t&&window?void(window.location.href=o):o},h=l(h),h=c(h)}/*!
	 ...
	 *
	 */
var r=n(21),o=n(48),s=n(14),a=n(18),l=n(73),c=n(72);e.exports=new i}).call(t,n(5))},function(e,t){e.exports=function(){throw new Error("define cannot be used indirect")}},function(e,t,n){"use strict";var i=n(60),r=n(11),o=window.moment=n(6),s=n(49);window.fullcalendar=n(45),n(50),n(61);var a=n(7),l=n(9),c=n(10),u=n(20);n(62),n(65),n(63),n(64);var d,h,f,p,g,m=u.instance,v=function(e){var t=e.targetEl||a.retrieve().targetEl||l.primary.targetEl;if(d=r(t),0===d.length)throw P("No target DOM element was found ("+t+")");d.addClass("bookingjs"),d.children(":not(script)").remove()},b=function(){var e={};a.retrieve().resources&&(e.resources=a.retrieve().resources),a.retrieve().availability_constraints&&(e.availability_constraints=a.retrieve().availability_constraints),a.retrieve().projectId&&(e.project_id=a.retrieve().projectId),r.extend(e,a.retrieve().availability),c.doCallback("findTimeStarted",e),m.makeRequest({method:"post",url:"/availability",data:e}).then(function(e){c.doCallback("findTimeSuccessful",e),R(),e.data.length>0&&M(e.data),e.headers["timekit-testmode"]&&D()}).catch(function(e){c.doCallback("findTimeFailed",e),R(),P(["An error with Timekit FindTime occured",e])})},y=function(){c.doCallback("GetBookingSlotsStarted");var e={url:"/bookings/groups",method:"get"};a.retrieve().projectId&&(e.params={search:"project.id:"+a.retrieve().projectId}),m.makeRequest(e).then(function(e){var t=e.data.map(function(e){return{title:e.attributes.event_info.what,start:e.attributes.event_info.start,end:e.attributes.event_info.end,booking:e}});t.sort(function(e,t){return o(e.start)-o(t.start)}),c.doCallback("getBookingSlotsSuccessful",e),R(),t.length>0&&M(t),e.headers["timekit-testmode"]&&D()}).catch(function(e){c.doCallback("getBookingSlotsFailed",e),R(),P(["An error with Timekit GetBookings occured",e])})},w=function(){z(),h.fullCalendar("removeEventSources"),"group_customer"===a.retrieve().booking.graph||"group_customer_payment"===a.retrieve().booking.graph?y():b()},k=function(e){h.fullCalendar("gotoDate",e);var t=o(e).format("H");A(t)},A=function(e){if("agendaWeek"===h.fullCalendar("getView").name){var t=h.fullCalendar("option","slotDuration"),n=30;t&&(n=t.slice(3,5));var i=h.find(".fc-slats .fc-minor"),s=r(i[0]).height()*(60/n),l=0;if(a.retrieve().fullCalendar.minTime){var c=o(a.retrieve().fullCalendar.minTime,"HH:mm:ss").format("H");l=s*c}var u=s*e-l,d=h.find(".fc-scroller"),f=d.height(),p=d.scrollTop(),g=d.find(".fc-time-grid").height();u>p&&u<p+f||(u>g-f&&(u=g-f),d.animate({scrollTop:u}))}},S=function(){var e=o().utcOffset()/60,t=n(71),s=n(16),l=r(s.render({timezoneIcon:t,loadingText:a.retrieve().localization.strings.timezoneHelperLoading,loading:!0}));d.addClass("has-timezonehelper"),d.append(l);var u={email:a.retrieve().email};c.doCallback("getUserTimezoneStarted",u),m.getUserTimezone(u).then(function(o){c.doCallback("getUserTimezoneSuccessful",o);var s=o.data.utc_offset,u=e-s,d=Math.abs(e-s),h=u>0?"ahead of":"behind",f=n(16),p=r(f.render({timezoneIcon:t,timezoneDifference:0!==d,timezoneDifferent:i.sprintf(a.retrieve().localization.strings.timezoneHelperDifferent,d,h,a.retrieve().name),timezoneSame:i.sprintf(a.retrieve().localization.strings.timezoneHelperSame,a.retrieve().name)}));l.replaceWith(p)}).catch(function(e){c.doCallback("getUserTimezoneFailed",e),c.logError(["An error with Timekit getUserTimezone occured",e])})},D=function(){var e=n(57),t=r(e.render({ribbonText:"Test Mode"}));d.append(t)},x=function(){var e=T(a.retrieve().fullCalendar.defaultView),t={height:e.height,eventClick:E,windowResize:function(){var e=T();h.fullCalendar("changeView",e.view),h.fullCalendar("option","height",e.height)}};r.extend(!0,t,a.retrieve().fullCalendar),t.defaultView=e.view,h=r('<div class="bookingjs-calendar empty-calendar">'),d.append(h),h.fullCalendar(t),c.doCallback("fullCalendarInitialized")},E=function(e){a.retrieve().disableConfirmPage?(r(".fc-event-clicked").removeClass("fc-event-clicked"),r(this).addClass("fc-event-clicked"),c.doCallback("clickTimeslot",e)):I(e)},T=function(e){e=e||h.fullCalendar("getView").name;var t=a.retrieve().fullCalendar.defaultView,n=430;return d.width()<480?(n=390,d.addClass("is-small"),a.retrieve().avatar&&(n-=15),"agendaWeek"!==e&&"basicDay"!==e||(t="basicDay")):d.removeClass("is-small"),a.retrieve().bookingFields.comment.enabled&&(n+=100),a.retrieve().bookingFields.phone.enabled&&(n+=64),a.retrieve().bookingFields.voip.enabled&&(n+=64),a.retrieve().bookingFields.location.enabled&&(n+=64),a.retrieve().localization.showTimezoneHelper||(n+=33),{height:n,view:t}},M=function(e){var t=o(e[0].start),n=o(e[0].end),i=n.diff(t,"minutes");i<=90&&h.fullCalendar("option","slotDuration","00:15:00"),h.fullCalendar("addEventSource",{events:e}),h.removeClass("empty-calendar"),a.retrieve().goToFirstEvent&&k(e[0].start)},C=function(){var e=n(58),t=r(e.render({image:a.retrieve().avatar}));d.addClass("has-avatar"),d.append(t)},_=function(){var e=n(59),t=r(e.render({name:a.retrieve().name}));d.addClass("has-displayname"),d.append(t)},z=function(){c.doCallback("showLoadingScreen");var e=n(55);p=r(e.render({loadingIcon:n(17)})),d.append(p)},R=function(){c.doCallback("hideLoadingScreen"),p.removeClass("show"),setTimeout(function(){p.remove()},500)},P=function(e){if(g)return e;if(c.doCallback("errorTriggered"),c.logError(e),!d)return e;var t=e,i=null;c.isArray(e)&&(t=e[0],i=s(e[1].data?e[1].data.errors||e[1].data.error||e[1].data:e[1]));var o=n(54);return g=r(o.render({errorWarningIcon:n(69),message:t,context:i})),d.append(g),e},I=function(e){c.doCallback("showBookingPage",e);var t=n(52),s=n(53),l=a.retrieve().localization.bookingDateFormat||o.localeData().longDateFormat("LL"),u=a.retrieve().localization.bookingTimeFormat||o.localeData().longDateFormat("LT"),h=!!e.users&&e.users[0].name;f=r(s.render({chosenDate:o(e.start).format(l),chosenTime:o(e.start).format(u)+" - "+o(e.end).format(u),allocatedResourcePrefix:a.retrieve().localization.strings.allocatedResourcePrefix,allocatedResource:h,closeIcon:n(67),checkmarkIcon:n(66),loadingIcon:n(17),errorIcon:n(68),submitText:a.retrieve().localization.strings.submitText,successMessageTitle:a.retrieve().localization.strings.successMessageTitle,successMessageBody:i.sprintf(a.retrieve().localization.strings.successMessageBody,'<span class="booked-email"></span>'),fields:a.retrieve().bookingFields},{formFields:t}));var p=f.children(".bookingjs-form");f.children(".bookingjs-bookpage-close").click(function(e){e.preventDefault();var t=r(p).hasClass("success");t&&w(),H()}),e.users&&c.logDebug(["Available users for chosen timeslot:",e.users]),p.find(".bookingjs-form-input").on("input",function(){var e=r(this).closest(".bookingjs-form-field");this.value?e.addClass("bookingjs-form-field--dirty"):e.removeClass("bookingjs-form-field--dirty")}),p.submit(function(t){L(this,t,e)}),a.retrieve().showCredits&&F(f),r(document).on("keyup",function(e){27===e.keyCode&&H()}),d.append(f),setTimeout(function(){f.addClass("show")},100)},H=function(){c.doCallback("closeBookingPage"),f.removeClass("show"),setTimeout(function(){f.remove()},200),r(document).off("keyup")},L=function(e,t,n){t.preventDefault();var i=r(e);if(i.hasClass("success"))return w(),void H();if(i.hasClass("loading")||i.hasClass("error")||!t.target.checkValidity()){var o=i.find(".bookingjs-form-button");return o.addClass("button-shake"),void setTimeout(function(){o.removeClass("button-shake")},500)}var s={};r.each(i.serializeArray(),function(e,t){s[t.name]=t.value}),i.addClass("loading"),c.doCallback("submitBookingForm",s),O(s,n).then(function(e){i.find(".booked-email").html(s.email),i.removeClass("loading").addClass("success")}).catch(function(e){j(i)})},j=function(e){var t=e.find(".bookingjs-form-button");t.addClass("button-shake"),setTimeout(function(){t.removeClass("button-shake")},500),e.removeClass("loading").addClass("error"),setTimeout(function(){e.removeClass("error")},2e3)},O=function(e,t){var n={event:{start:t.start.format(),end:t.end.format(),what:a.retrieve().name+" x "+e.name,where:"TBD",description:"",participants:[e.email]},customer:{name:e.name,email:e.email,timezone:o.tz.guess()}};if(a.retrieve().calendar&&(n.event.calendar_id=a.retrieve().calendar),a.retrieve().bookingFields.location.enabled&&(n.customer.where=e.location,n.event.where=e.location),a.retrieve().bookingFields.comment.enabled&&(n.customer.comment=e.comment,n.event.description+=a.retrieve().bookingFields.comment.placeholder+": "+e.comment+"\n"),a.retrieve().bookingFields.phone.enabled&&(n.customer.phone=e.phone,n.event.description+=a.retrieve().bookingFields.phone.placeholder+": "+e.phone+"\n"),a.retrieve().bookingFields.voip.enabled&&(n.customer.voip=e.voip,n.event.description+=a.retrieve().bookingFields.voip.placeholder+": "+e.voip+"\n"),r.extend(!0,n,a.retrieve().booking),"group_customer"===a.retrieve().booking.graph||"group_customer_payment"===a.retrieve().booking.graph)delete n.event,n.related={owner_booking_id:t.booking.id},n.resource_id=t.booking.resource_id;else{if("undefined"==typeof t.resources||0===t.resources.length)throw P(["No resources to pick from when creating booking"]);n.resource_id=t.resources[0]}a.retrieve().projectId&&(n.project_id=a.retrieve().projectId),c.doCallback("createBookingStarted",n);var i={"Timekit-OutputTimestampFormat":"Y-m-d "+a.retrieve().localization.emailTimeFormat+" (P e)"},s=m.include("attributes","event","user").headers(i).createBooking(n);return s.then(function(e){c.doCallback("createBookingSuccessful",e)}).catch(function(e){c.doCallback("createBookingFailed",e),P(["An error with Timekit CreateBooking occured",e])}),s},F=function(e){var t="widget",i=window.location.hostname.replace(/\./g,"-");a.retrieve().projectId&&(t="embedded-widget"),a.retrieve().projectSlug&&(t="hosted-widget");var o=n(56),s=n(70),l=r(o.render({timekitLogo:s,campaignName:t,campaignSource:i}));e.append(l)},B=function(){if(void 0!==h.fullCalendar)return h.fullCalendar.apply(h,arguments)};e.exports={prepareDOM:v,getAvailability:w,renderTimezoneHelper:S,initializeCalendar:x,renderAvatarImage:C,renderDisplayName:_,triggerError:P,timekitCreateBooking:O,fullCalendar:B}},function(e,t){}])});