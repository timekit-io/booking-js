!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof exports?exports.TimekitBooking=t(require("jquery")):e.TimekitBooking=t(e.jQuery)}(this,function(e){return function(e){function t(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return e[i].call(r.exports,r,r.exports,t),r.loaded=!0,r.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function i(){var e,t,i,u={},d=function(){n(47),n(48),n(50),n(49)},f=function(){e=r(u.targetEl),0===e.length&&(e=r("#hourwidget")),0===e.length&&l.logError("No target DOM element was found ("+u.targetEl+")"),e.addClass("bookingjs"),e.children(":not(script)").remove()},h=function(){u.app&&(u.timekitConfig.app=u.app),a.configure(u.timekitConfig)},p=function(){a.setUser(u.email,u.apiToken)},g=function(){var e={};u.timekitFindTime.calendar_ids||u.timekitFindTime.user_ids||(e.emails=[u.email]),r.extend(e,u.timekitFindTime),l.doCallback("findTimeStarted",u,e),a.findTime(e).then(function(e){l.doCallback("findTimeSuccessful",u,e),e.data.length>0&&k(e.data)}).catch(function(e){l.doCallback("findTimeFailed",u,e),l.logError("An error with Timekit FindTime occured, context: "+e)})},m=function(){l.doCallback("GetBookingSlotsStarted",u);var e={url:"/bookings/groups",method:"get"};u.widgetId&&(e.params={search:"widget.id:"+u.widgetId}),a.makeRequest(e).then(function(e){var t=e.data.map(function(e){return{title:e.attributes.event_info.what,start:e.attributes.event_info.start,end:e.attributes.event_info.end,booking:e}});l.doCallback("getBookingSlotsSuccessful",u,e),t.length>0&&k(t)}).catch(function(e){l.doCallback("getBookingSlotsFailed",u,e),l.logError("An error with Timekit GetBookings occured, context: "+e)})},v=function(){t.fullCalendar("removeEventSources"),"group_customer"===u.bookingGraph||"group_customer_payment"===u.bookingGraph?m():g()},b=function(e){t.fullCalendar("gotoDate",e);var n=o(e).format("H");y(n)},y=function(e){if("agendaWeek"===t.fullCalendar("getView").name){var n=t.fullCalendar("option","slotDuration"),i=30;n&&(i=n.slice(3,5));var a=t.find(".fc-slats .fc-minor"),s=r(a[0]).height()*(60/i),l=0;if(u.fullCalendar.minTime){var c=o(u.fullCalendar.minTime,"HH:mm:ss").format("H");l=s*c}var d=s*e-l,f=t.find(".fc-scroller"),h=f.height(),p=f.scrollTop(),g=f.find(".fc-time-grid").height();d>p&&d<p+h||(d>g-h&&(d=g-h),f.animate({scrollTop:d}))}},w=function(){var t=o().utcOffset()/60,i=n(56),c=n(9),d=r(c.render({timezoneIcon:i,loadingText:u.localization.strings.timezoneHelperLoading,loading:!0}));e.addClass("has-timezonehelper"),e.append(d);var f={email:u.email};l.doCallback("getUserTimezoneStarted",u,f),a.getUserTimezone(f).then(function(e){l.doCallback("getUserTimezoneSuccessful",u,e);var o=e.data.utc_offset,a=t-o,c=Math.abs(t-o),f=a>0?"ahead":"behind",h=n(9),p=r(h.render({timezoneIcon:i,timezoneDifference:0!==c,timezoneDifferent:s.sprintf(u.localization.strings.timezoneHelperDifferent,c,f,u.name),timezoneSame:s.sprintf(u.localization.strings.timezoneHelperSame,u.name)}));d.replaceWith(p)}).catch(function(e){l.doCallback("getUserTimezoneFailed",u,e),l.logError("An error with Timekit getUserTimezone occured, context: "+e)})},A=function(){var n=S(),i={defaultView:n.view,height:n.height,eventClick:E,windowResize:function(){var e=S();t.fullCalendar("changeView",e.view),t.fullCalendar("option","height",e.height)}};r.extend(!0,i,u.fullCalendar),t=r('<div class="bookingjs-calendar empty-calendar">'),e.append(t),t.fullCalendar(i),e.addClass("show"),l.doCallback("fullCalendarInitialized",u)},S=function(){var t="agendaWeek",n=420,i=e.width();return i<480?(t="basicDay",n=380,e.addClass("is-small"),u.avatar&&(n-=15)):e.removeClass("is-small"),u.bookingFields.comment.enabled&&(n+=84),u.bookingFields.phone.enabled&&(n+=64),u.bookingFields.voip.enabled&&(n+=64),u.bookingFields.location.enabled&&(n+=64),u.localization.showTimezoneHelper||(n+=33),{height:n,view:t}},k=function(e){var n=o(e[0].start),i=o(e[0].end),r=i.diff(n,"minutes");r<=90&&t.fullCalendar("option","slotDuration","00:15:00"),t.fullCalendar("addEventSource",{events:e}),t.removeClass("empty-calendar"),u.goToFirstEvent&&b(e[0].start)},T=function(){var t=n(44),i=r(t.render({image:u.avatar}));e.addClass("has-avatar"),e.append(i)},x=function(){var t=n(45),i=r(t.render({name:u.name}));e.addClass("has-displayname"),e.append(i)},E=function(t){l.doCallback("showBookingPage",u,t);var a=n(41),c=n(42),d=u.localization.bookingDateFormat||o.localeData().longDateFormat("LL"),f=u.localization.bookingTimeFormat||o.localeData().longDateFormat("LT");i=r(c.render({chosenDate:o(t.start).format(d),chosenTime:o(t.start).format(f)+" - "+o(t.end).format(f),start:o(t.start).format(),end:o(t.end).format(),closeIcon:n(52),checkmarkIcon:n(51),loadingIcon:n(54),errorIcon:n(53),submitText:u.localization.strings.submitText,successMessageTitle:u.localization.strings.successMessageTitle,successMessageBody:s.sprintf(u.localization.strings.successMessageBody,'<span class="booked-email"></span>'),fields:u.bookingFields},{formFields:a}));var h=i.children(".bookingjs-form");i.children(".bookingjs-bookpage-close").click(function(e){e.preventDefault(),D();var t=r(h).hasClass("success");t&&v()}),h.submit(function(e){M(this,e,t)}),u.showCredits&&z(i),r(document).on("keyup",function(e){27===e.keyCode&&D()}),e.append(i),setTimeout(function(){i.addClass("show")},100)},D=function(){l.doCallback("closeBookingPage",u),i.removeClass("show"),setTimeout(function(){i.remove()},200),r(document).off("keyup")},M=function(e,t,n){t.preventDefault();var i=r(e);if(i.hasClass("loading")||i.hasClass("success")||i.hasClass("error")||!t.target.checkValidity()){var o=i.find(".bookingjs-form-button");return o.addClass("button-shake"),void setTimeout(function(){o.removeClass("button-shake")},500)}var a={};r.each(i.serializeArray(),function(e,t){a[t.name]=t.value}),i.addClass("loading"),l.doCallback("submitBookingForm",u,a),C(a,n).then(function(e){l.doCallback("createBookingSuccessful",u,e),i.find(".booked-email").html(a.email),i.removeClass("loading").addClass("success")}).catch(function(e){l.doCallback("createBookingFailed",u,e),_(i),l.logError("An error with Timekit createBooking occured, context: "+e)})},_=function(e){var t=e.find(".bookingjs-form-button");t.addClass("button-shake"),setTimeout(function(){t.removeClass("button-shake")},500),e.removeClass("loading").addClass("error"),setTimeout(function(){e.removeClass("error")},2e3)},C=function(e,t){var n={event:{start:e.start,end:e.end,what:u.name+" x "+e.name,where:"TBD",description:"",calendar_id:u.calendar,participants:[e.email]},customer:{name:e.name,email:e.email,timezone:o.tz.guess()}};u.widgetId&&(n.widget_id=u.widgetId),u.bookingFields.location.enabled&&(n.event.where=e.location),u.bookingFields.comment.enabled&&(n.event.description+=u.bookingFields.comment.placeholder+": "+e.comment+"\n"),u.bookingFields.phone.enabled&&(n.customer.phone=e.phone,n.event.description+=u.bookingFields.phone.placeholder+": "+e.phone+"\n"),u.bookingFields.voip.enabled&&(n.customer.voip=e.voip,n.event.description+=u.bookingFields.voip.placeholder+": "+e.voip+"\n"),r.extend(!0,n,u.timekitCreateBooking),"group_customer"!==u.bookingGraph&&"group_customer_payment"!==u.bookingGraph||(delete n.event,n.related={owner_booking_id:t.booking.id}),l.doCallback("createBookingStarted",u,n);var i={"Timekit-OutputTimestampFormat":"Y-m-d "+u.localization.emailTimeFormat+" (P e)"};return a.include("attributes","event").headers(i).createBooking(n)},z=function(e){var t="widget",i=window.location.hostname.replace(/\./g,"-");u.widgetId&&(t="embedded-widget"),u.widgetSlug&&(t="hosted-widget");var o=n(43),a=n(55),s=r(o.render({timekitLogo:a,campaignName:t,campaignSource:i}));e.append(s)},H=function(e){return r.extend(!0,{},c.primary,e)},L=function(e){(void 0===e||"object"!=typeof e||r.isEmptyObject(e))&&l.logError("No configuration was supplied or found. Please supply a config object upon library initialization");var t=H(e),n={},i=c.presets.timeDateFormat[t.localization.timeDateFormat];i&&(n=i);var o=r.extend(!0,{},n,t);n={};var a=c.presets.bookingGraph[t.bookingGraph];return a&&(n=a),o=r.extend(!0,{},n,o),o.email||l.logError('A required config setting ("email") was missing'),o.apiToken||l.logError('A required config setting ("apiToken") was missing'),o.calendar||"group_customer"===o.bookingGraph||"group_customer_payment"===o.bookingGraph||l.logError('A required config setting ("calendar") was missing'),u=o},R=function(){return u},O=function(){return d(),f(),h(),p(),A(),v(),u.localization.showTimezoneHelper&&w(),u.avatar&&T(),u.name&&x(),l.doCallback("renderCompleted",u),this},B=function(e){return!e.widgetId&&!e.widgetSlug||e.disableRemoteLoad?j(e):P(e).then(function(t){var n=t.data.config;t.data.id&&(n.widgetId=t.data.id);var i=r.extend(!0,{},n,e);j(i)})},P=function(e){return u=H(e),h(),e.widgetId?a.getEmbedWidget({id:e.widgetId}).catch(function(){l.logError("The widget could not be found, please double-check your widgetId")}):e.widgetSlug?a.getHostedWidget({slug:e.widgetSlug}).catch(function(){l.logError("The widget could not be found, please double-check your widgetSlug")}):void l.logError("No widget configuration, widgetSlug or widgetId found")},j=function(e){return L(e),O()},I=function(){return f(),u={},this},W=function(){if(void 0!==t.fullCalendar)return t.fullCalendar.apply(t,arguments)};return{setConfig:L,getConfig:R,render:O,init:B,destroy:I,fullCalendar:W,timekitSdk:a}}/*!
	 * Booking.js
	 * Version: 1.10.0
	 * http://timekit.io
	 *
