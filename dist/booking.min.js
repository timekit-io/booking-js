 ...
 *
 */var i=n(6),r=n(29),o=window.timekitBookingConfig;window&&o&&!1!==o.autoload?i(window).on("load",(function(){var t=new r;t.init(o),e.exports=t})):e.exports=r},function(e,t,n){"use strict";var i=n(6),r=n(30),o=n(55),a=n(58),s=n(60);e.exports=function(){var e=r.newInstance(),t=new o,n=new a({config:t}),l=new s({config:t,utils:n,sdk:e}),c=t.retrieve,u=function(t){e.configure(c().sdk)},d=function(t){if(!t.app_key)return l.triggerError('Missing "app_key" in conjunction with "project_id", please provide your "app_key" for authentication'),this;u(),e.makeRequest({url:"/projects/embed/"+t.project_id,method:"get"}).then((function(e){h(e,t)})).catch((function(e){l.triggerError(['The project could not be found, please double-check your "project_id" and "app_key"',e])}))},f=function(t){u(),e.makeRequest({url:"/projects/hosted/"+t.project_slug,method:"get"}).then((function(e){h(e,t)})).catch((function(e){l.triggerError(['The project could not be found, please double-check your "project_slug"',e])}))},h=function(e,t){var r=e.data;r.id&&(r.project_id=r.id,delete r.id),r.slug&&(r.project_slug=r.slug,delete r.slug);var o=i.extend(!0,{},r,t);n.logDebug(["Remote config:",r]),p(o)},p=function(e){try{t.parseAndUpdate(e)}catch(e){return l.triggerError(e),this}n.logDebug(["Final config:",c()]);try{return g()}catch(e){return l.triggerError(e),this}},g=function(){return n.doCallback("renderStarted"),u(),c().ui.timezone?l.setCustomerTimezone(c().ui.timezone):l.guessCustomerTimezone(),l.initializeCalendar(),l.getAvailability(),c().ui.avatar&&l.renderAvatarImage(),c().ui.display_name&&l.renderDisplayName(),l.renderFooter(),n.doCallback("renderCompleted"),this},m=function(){return"2.7.3"};return{setConfig:t.parseAndUpdate,getConfig:c,getVersion:m,render:g,init:function(e,i){i=i||window,t.setGlobal(i);var r=t.setDefaults(e||{});t.update(r),n.logDebug(["Version:",m()]),n.logDebug(["Supplied config:",e]);try{l.prepareDOM(e||{})}catch(e){return n.logError(e),this}if(!n.doesConfigExist(e))return l.triggerError("No configuration was supplied. Please supply a config object upon library initialization"),this;if(!n.isRemoteProject(e)||e.disable_remote_load){var o=t.setDefaultsWithoutProject(e);return p(o)}return n.isEmbeddedProject(e)&&d(e),n.isHostedProject(e)&&f(e),this},destroy:function(){return l.destroyFullCalendar(),l.prepareDOM({}),t.update({}),this},timekitCreateBooking:l.timekitCreateBooking,fullCalendar:l.fullCalendar,timekitSdk:e}}},function(e,t,n){"use strict";(function(t){
/*!
 ...
 *
 */
var i=n(33),r=n(51),o=n(22),a=n(23),s=n(53),l=n(54);e.exports=new function e(){var n=[],c={},u={},d={app:"",apiBaseUrl:"https://api.timekit.io/",apiVersion:"v2",convertResponseToCamelcase:!1,convertRequestToSnakecase:!0,autoFlattenResponse:!0,resourceEmail:null,resourceKey:null,appKey:null},f={makeRequest:function(e){e=a.mergeNextPayload(e,u),u={},e.url=a.buildUrl(e.url,d),e.headers=e.headers||c||{},d.headers&&(e.headers=o(d.headers,e.headers)),!e.headers["Timekit-App"]&&d.app&&(e.headers["Timekit-App"]=d.app),d.inputTimestampFormat&&(e.headers["Timekit-InputTimestampFormat"]=d.inputTimestampFormat),d.outputTimestampFormat&&(e.headers["Timekit-OutputTimestampFormat"]=d.outputTimestampFormat),d.timezone&&(e.headers["Timekit-Timezone"]=d.timezone),!e.headers.Authorization&&d.resourceEmail&&d.resourceKey&&(e.headers.Authorization="Basic "+a.encodeAuthHeader(d.resourceEmail,d.resourceKey)),!e.headers.Authorization&&d.appKey&&(e.headers.Authorization="Basic "+a.encodeAuthHeader("",d.appKey)),Object.keys(c).length>0&&(c={}),n&&n.length>0&&(void 0===e.params&&(e.params={}),e.params.include=n.join(),n=[]),e.data&&d.convertRequestToSnakecase&&(e.data=r.decamelizeKeys(e.data));var s=i.interceptors.response.use((function(e){return e.data&&e.data.data&&(d.autoFlattenResponse&&(e=a.copyResponseMetaData(e)),d.convertResponseToCamelcase&&(e.data=r.camelizeKeys(e.data))),e}),(function(e){return e.response?t.reject(e.response):e.request?t.reject(e.request):t.reject(e)})),l=i(e);return i.interceptors.response.eject(s),l},configure:function(e){for(var t in e)d[t]=e[t];return d},getConfig:function(){return d},setUser:function(e,t){d.resourceEmail=e,d.resourceKey=t},getUser:function(){return{email:d.resourceEmail,apiToken:d.resourceKey}},setAppKey:function(e){d.appKey=e},getAppKey:function(){return d.appKey},asUser:function(e,t){return c.Authorization="Basic "+a.encodeAuthHeader(e,t),this},asApp:function(e){return c["Timekit-App"]=e,this},include:function(e){return n=Array.isArray(e)?e:Array.prototype.slice.call(arguments),this},headers:function(e){return c=o(c,e),this},carry:function(e){return u=o(u,e),this},newInstance:function(){return new e},accountGoogleSignup:function(e,t){var n=d.app;c["Timekit-App"]&&(n=c["Timekit-App"]);var i=a.buildUrl("/accounts/google/signup",d)+"?Timekit-App="+n+(e&&e.callback?"&callback="+e.callback:"");if(!t||!window)return i;window.location.href=i},accountMicrosoftSignup:function(e,t){var n=d.app;c["Timekit-App"]&&(n=c["Timekit-App"]);var i=a.buildUrl("/accounts/microsoft/signup",d)+"?Timekit-App="+n+(e&&e.callback?"&callback="+e.callback:"");if(!t||!window)return i;window.location.href=i}};return f=s(f),f=l(f)}}).call(this,n(4))},function(e,t,n){(function(t,i){var r;
/*!
