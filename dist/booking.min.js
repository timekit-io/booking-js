 ...
 *
 */var i=n(6),r=n(29),o=window.timekitBookingConfig;window&&o&&!1!==o.autoload?i(window).on("load",(function(){var t=new r;t.init(o),e.exports=t})):e.exports=r},function(e,t,n){"use strict";var i=n(6),r=n(30),o=n(55),a=n(58),s=n(60);e.exports=function(){var e=r.newInstance({apiBaseUrl:"https://api-localhost.timekit.io/"}),t=new o,n=t.retrieve,l=new a({config:t}),c=new s({config:t,utils:l,sdk:e}),u=function(t){e.configure(n().sdk)},d=function(t){if(!t.app_key)return c.triggerError('Missing "app_key" in conjunction with "project_id", please provide your "app_key" for authentication'),this;u(),e.makeRequest({url:"/projects/embed/"+t.project_id,method:"get"}).then((function(e){h(e,t)})).catch((function(e){c.triggerError(['The project could not be found, please double-check your "project_id" and "app_key"',e])}))},f=function(t){u(),e.makeRequest({url:"/projects/hosted/"+t.project_slug,method:"get"}).then((function(e){h(e,t)})).catch((function(e){c.triggerError(['The project could not be found, please double-check your "project_slug"',e])}))},h=function(e,t){var n=e.data;n.id&&(n.project_id=n.id,delete n.id),n.slug&&(n.project_slug=n.slug,delete n.slug);var r=i.extend(!0,{},n,t);l.logDebug(["Remote config:",n]),p(r)},p=function(e){try{t.parseAndUpdate(e)}catch(e){return c.triggerError(e),this}l.logDebug(["Final config:",n()]);try{return g()}catch(e){return c.triggerError(e),this}},g=function(){return l.doCallback("renderStarted"),u(),n().ui.timezone?c.setCustomerTimezone(n().ui.timezone):c.guessCustomerTimezone(),c.initializeCalendar(),c.getAvailability(),n().ui.avatar&&c.renderAvatarImage(),n().ui.display_name&&c.renderDisplayName(),c.renderFooter(),l.doCallback("renderCompleted"),this},m=function(){return"2.7.1"};return{setConfig:t.parseAndUpdate,getConfig:n,getVersion:m,render:g,init:function(e,n){n=n||window,t.setGlobal(n);var i=t.setDefaults(e||{});t.update(i),l.logDebug(["Version:",m()]),l.logDebug(["Supplied config:",e]);try{c.prepareDOM(e||{})}catch(e){return l.logError(e),this}if(!l.doesConfigExist(e))return c.triggerError("No configuration was supplied. Please supply a config object upon library initialization"),this;if(!l.isRemoteProject(e)||e.disable_remote_load){var r=t.setDefaultsWithoutProject(e);return p(r)}return l.isEmbeddedProject(e)&&d(e),l.isHostedProject(e)&&f(e),this},destroy:function(){return c.destroyFullCalendar(),c.prepareDOM({}),t.update({}),this},timekitCreateBooking:c.timekitCreateBooking,fullCalendar:c.fullCalendar,timekitSdk:e}}},function(e,t,n){"use strict";(function(t){
/*!
