!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof exports?exports.TimekitBooking=t(require("jquery")):e.TimekitBooking=t(e.jQuery)}(this,function(e){return function(e){function t(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return e[i].call(r.exports,r,r.exports,t),r.loaded=!0,r.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function i(){var e,t,i,u,d,f=a.newInstance(),p={},h=function(t){var n=t.targetEl||p.targetEl||c.primary.targetEl;if(e=r(n),0===e.length)throw P("No target DOM element was found ("+n+")");e.addClass("bookingjs"),e.children(":not(script)").remove()},g=function(){f.configure(p.timekitConfig)},m=function(){f.setUser(p.email,p.apiToken)},v=function(){var e={};p.timekitFindTime.calendar_ids||p.timekitFindTime.user_ids||(e.emails=[p.email]),r.extend(e,p.timekitFindTime),l.doCallback("findTimeStarted",p,e),f.findTime(e).then(function(e){l.doCallback("findTimeSuccessful",p,e),z(),e.data.length>0&&M(e.data),e.headers["timekit-testmode"]&&D()}).catch(function(e){l.doCallback("findTimeFailed",p,e),z(),P(["An error with Timekit FindTime occured",e])})},b=function(){var e={url:"/findtime/team",method:"post",data:p.timekitFindTimeTeam};r.each(p.timekitFindTimeTeam.users,function(e,t){r.extend(t,p.timekitFindTime),t.calendar_ids||t.user_ids||(t.emails=[t._email])}),l.doCallback("findTimeTeamStarted",p,e),f.makeRequest(e).then(function(e){l.doCallback("findTimeTeamSuccessful",p,e),z(),e.data.length>0&&M(e.data),e.headers["timekit-testmode"]&&D()}).catch(function(e){l.doCallback("findTimeTeamFailed",p,e),z(),P(["An error with Timekit FindTimeTeam occured",e])})},y=function(){l.doCallback("GetBookingSlotsStarted",p);var e={url:"/bookings/groups",method:"get"};p.widgetId&&(e.params={search:"widget.id:"+p.widgetId}),f.makeRequest(e).then(function(e){var t=e.data.map(function(e){return{title:e.attributes.event_info.what,start:e.attributes.event_info.start,end:e.attributes.event_info.end,booking:e}});t.sort(function(e,t){return s(e.start)-s(t.start)}),l.doCallback("getBookingSlotsSuccessful",p,e),z(),t.length>0&&M(t),e.headers["timekit-testmode"]&&D()}).catch(function(e){l.doCallback("getBookingSlotsFailed",p,e),z(),P(["An error with Timekit GetBookings occured",e])})},w=function(){R(),t.fullCalendar("removeEventSources"),"group_customer"===p.bookingGraph||"group_customer_payment"===p.bookingGraph?y():p.timekitFindTimeTeam?b():v()},k=function(e){t.fullCalendar("gotoDate",e);var n=s(e).format("H");A(n)},A=function(e){if("agendaWeek"===t.fullCalendar("getView").name){var n=t.fullCalendar("option","slotDuration"),i=30;n&&(i=n.slice(3,5));var o=t.find(".fc-slats .fc-minor"),a=r(o[0]).height()*(60/i),l=0;if(p.fullCalendar.minTime){var c=s(p.fullCalendar.minTime,"HH:mm:ss").format("H");l=a*c}var u=a*e-l,d=t.find(".fc-scroller"),f=d.height(),h=d.scrollTop(),g=d.find(".fc-time-grid").height();u>h&&u<h+f||(u>g-f&&(u=g-f),d.animate({scrollTop:u}))}},S=function(){var t=s().utcOffset()/60,i=n(66),a=n(12),c=r(a.render({timezoneIcon:i,loadingText:p.localization.strings.timezoneHelperLoading,loading:!0}));e.addClass("has-timezonehelper"),e.append(c);var u={email:p.email};l.doCallback("getUserTimezoneStarted",p,u),f.getUserTimezone(u).then(function(e){l.doCallback("getUserTimezoneSuccessful",p,e);var a=e.data.utc_offset,s=t-a,u=Math.abs(t-a),d=s>0?"ahead of":"behind",f=n(12),h=r(f.render({timezoneIcon:i,timezoneDifference:0!==u,timezoneDifferent:o.sprintf(p.localization.strings.timezoneHelperDifferent,u,d,p.name),timezoneSame:o.sprintf(p.localization.strings.timezoneHelperSame,p.name)}));c.replaceWith(h)}).catch(function(e){l.doCallback("getUserTimezoneFailed",p,e),l.logError(["An error with Timekit getUserTimezone occured",e])})},D=function(){var t=n(52),i=r(t.render({ribbonText:"Test Mode"}));e.append(i)},_=function(){var n=E(p.fullCalendar.defaultView),i={height:n.height,eventClick:x,windowResize:function(){var e=E();t.fullCalendar("changeView",e.view),t.fullCalendar("option","height",e.height)}};r.extend(!0,i,p.fullCalendar),i.defaultView=n.view,t=r('<div class="bookingjs-calendar empty-calendar">'),e.append(t),t.fullCalendar(i),l.doCallback("fullCalendarInitialized",p)},x=function(e){p.disableConfirmPage?(r(".fc-event-clicked").removeClass("fc-event-clicked"),r(this).addClass("fc-event-clicked"),l.doCallback("clickTimeslot",p,e)):I(e)},E=function(n){n=n||t.fullCalendar("getView").name;var i=p.fullCalendar.defaultView,r=430;return e.width()<480?(r=390,e.addClass("is-small"),p.avatar&&(r-=15),"agendaWeek"!==n&&"basicDay"!==n||(i="basicDay")):e.removeClass("is-small"),p.bookingFields.comment.enabled&&(r+=100),p.bookingFields.phone.enabled&&(r+=64),p.bookingFields.voip.enabled&&(r+=64),p.bookingFields.location.enabled&&(r+=64),p.localization.showTimezoneHelper||(r+=33),{height:r,view:i}},M=function(e){var n=s(e[0].start),i=s(e[0].end),r=i.diff(n,"minutes");r<=90&&t.fullCalendar("option","slotDuration","00:15:00"),t.fullCalendar("addEventSource",{events:e}),t.removeClass("empty-calendar"),p.goToFirstEvent&&k(e[0].start)},T=function(){var t=n(53),i=r(t.render({image:p.avatar}));e.addClass("has-avatar"),e.append(i)},C=function(){var t=n(54),i=r(t.render({name:p.name}));e.addClass("has-displayname"),e.append(i)},R=function(){l.doCallback("showLoadingScreen",p);var t=n(50);u=r(t.render({loadingIcon:n(13)})),e.append(u)},z=function(){l.doCallback("hideLoadingScreen",p),u.removeClass("show"),setTimeout(function(){u.remove()},500)},P=function(t){if(d)return t;if(l.doCallback("errorTriggered",t),l.logError(t),!e)return t;var i=t,o=null;l.isArray(t)&&(i=t[0],o=t[1].data?JSON.stringify(t[1].data.errors||t[1].data.error||t[1].data):JSON.stringify(t[1]));var a=n(49);return d=r(a.render({errorWarningIcon:n(64),message:i,context:o})),e.append(d),t},I=function(t){l.doCallback("showBookingPage",p,t);var a=n(47),c=n(48),u=p.localization.bookingDateFormat||s.localeData().longDateFormat("LL"),d=p.localization.bookingTimeFormat||s.localeData().longDateFormat("LT"),f=!!t.users&&t.users[0].name;i=r(c.render({chosenDate:s(t.start).format(u),chosenTime:s(t.start).format(d)+" - "+s(t.end).format(d),allocatedResourcePrefix:p.localization.strings.allocatedResourcePrefix,allocatedResource:f,closeIcon:n(62),checkmarkIcon:n(61),loadingIcon:n(13),errorIcon:n(63),submitText:p.localization.strings.submitText,successMessageTitle:p.localization.strings.successMessageTitle,successMessageBody:o.sprintf(p.localization.strings.successMessageBody,'<span class="booked-email"></span>'),fields:p.bookingFields},{formFields:a}));var h=i.children(".bookingjs-form");i.children(".bookingjs-bookpage-close").click(function(e){e.preventDefault();var t=r(h).hasClass("success");t&&w(),O()}),t.users&&l.logDebug(["Available users for chosen timeslot:",t.users],p),h.find(".bookingjs-form-input").on("input",function(){var e=r(this).closest(".bookingjs-form-field");this.value?e.addClass("bookingjs-form-field--dirty"):e.removeClass("bookingjs-form-field--dirty")}),h.submit(function(e){H(this,e,t)}),p.showCredits&&F(i),r(document).on("keyup",function(e){27===e.keyCode&&O()}),e.append(i),setTimeout(function(){i.addClass("show")},100)},O=function(){l.doCallback("closeBookingPage",p),i.removeClass("show"),setTimeout(function(){i.remove()},200),r(document).off("keyup")},H=function(e,t,n){t.preventDefault();var i=r(e);if(i.hasClass("success"))return w(),void O();if(i.hasClass("loading")||i.hasClass("error")||!t.target.checkValidity()){var o=i.find(".bookingjs-form-button");return o.addClass("button-shake"),void setTimeout(function(){o.removeClass("button-shake")},500)}var a={};r.each(i.serializeArray(),function(e,t){a[t.name]=t.value}),i.addClass("loading"),l.doCallback("submitBookingForm",p,a),L(a,n).then(function(e){i.find(".booked-email").html(a.email),i.removeClass("loading").addClass("success")}).catch(function(e){j(i)})},j=function(e){var t=e.find(".bookingjs-form-button");t.addClass("button-shake"),setTimeout(function(){t.removeClass("button-shake")},500),e.removeClass("loading").addClass("error"),setTimeout(function(){e.removeClass("error")},2e3)},L=function(e,t){var n={event:{start:t.start.format(),end:t.end.format(),what:p.name+" x "+e.name,where:"TBD",description:"",participants:[e.email]},customer:{name:e.name,email:e.email,timezone:s.tz.guess()}};if(p.calendar&&(n.event.calendar_id=p.calendar),p.bookingFields.location.enabled&&(n.customer.where=e.location,n.event.where=e.location),p.bookingFields.comment.enabled&&(n.customer.comment=e.comment,n.event.description+=p.bookingFields.comment.placeholder+": "+e.comment+"\n"),p.bookingFields.phone.enabled&&(n.customer.phone=e.phone,n.event.description+=p.bookingFields.phone.placeholder+": "+e.phone+"\n"),p.bookingFields.voip.enabled&&(n.customer.voip=e.voip,n.event.description+=p.bookingFields.voip.placeholder+": "+e.voip+"\n"),r.extend(!0,n,p.timekitCreateBooking),"group_customer"!==p.bookingGraph&&"group_customer_payment"!==p.bookingGraph||(delete n.event,n.related={owner_booking_id:t.booking.id}),t.users){var i=t.users[0],o=r.grep(p.timekitFindTimeTeam.users,function(e){return i.email===e._email});if(o.length<1)throw P(["Encountered an error when picking designated team user to receive booking",i,p.timekitFindTimeTeam.users]);f=f.asUser(i.email,i.token),o[0]._calendar&&(n.event.calendar_id=o[0]._calendar),l.logDebug(["Creating booking for user:",i],p)}!t.users&&p.widgetId&&(n.widget_id=p.widgetId),l.doCallback("createBookingStarted",p,n);var a={"Timekit-OutputTimestampFormat":"Y-m-d "+p.localization.emailTimeFormat+" (P e)"},c=f.include(p.createBookingResponseInclude).headers(a).createBooking(n);return c.then(function(e){l.doCallback("createBookingSuccessful",p,e)}).catch(function(e){l.doCallback("createBookingFailed",p,e),P(["An error with Timekit CreateBooking occured",e])}),c},F=function(e){var t="widget",i=window.location.hostname.replace(/\./g,"-");p.widgetId&&(t="embedded-widget"),p.widgetSlug&&(t="hosted-widget");var o=n(51),a=n(65),s=r(o.render({timekitLogo:a,campaignName:t,campaignSource:i}));e.append(s)},B=function(e){return r.extend(!0,{},c.primary,e)},N=function(e,t,n){var i=c.presets[t][n];return i?r.extend(!0,{},i,e):e},G=function(e){if(void 0===e||"object"!=typeof e||r.isEmptyObject(e))throw P("No configuration was supplied or found. Please supply a config object upon library initialization");var t=B(e);if(e.app&&(t.timekitConfig.app=e.app),t=N(t,"timeDateFormat",t.localization.timeDateFormat),t=N(t,"bookingGraph",t.bookingGraph),t=N(t,"availabilityView",t.availabilityView),!t.app&&!t.timekitConfig.app)throw P('A required config setting ("app") was missing');if(!t.email)throw P('A required config setting ("email") was missing');if(!t.apiToken)throw P('A required config setting ("apiToken") was missing');return p=t,l.logDebug(["Final config:",p],p),l.logDebug(["Version:",U()],p),p},Y=function(){return p},U=function(){return"1.24.3"},q=function(){return l.doCallback("renderStarted",p),g(),m(),_(),w(),p.localization.showTimezoneHelper&&S(),p.avatar&&T(),p.name&&C(),l.doCallback("renderCompleted",p),this},W=function(e){l.logDebug(["Supplied config:",e],e);try{if(h(e||{}),!e||!e.widgetId&&!e.widgetSlug||e.disableRemoteLoad)return Z(e)}catch(e){return this}return V(e).then(function(t){var n=t.data.config;t.data.id&&(n.widgetId=t.data.id);var i=r.extend(!0,{},n,e);l.logDebug(["Remote config:",n],i),Z(i)}).catch(function(){P("The widget could not be found, please double-check your widgetId/widgetSlug")}),this},V=function(e){if(p=B(e),g(),e.widgetId)return f.getEmbedWidget({id:e.widgetId});if(e.widgetSlug)return f.getHostedWidget({slug:e.widgetSlug});throw P("No widget configuration, widgetSlug or widgetId found")},Z=function(e){return G(e),q()},K=function(){return h({}),p={},this},X=function(){if(void 0!==t.fullCalendar)return t.fullCalendar.apply(t,arguments)};return{setConfig:G,getConfig:Y,getVersion:U,render:q,init:W,destroy:K,timekitCreateBooking:L,fullCalendar:X,timekitSdk:f}}/*!
	 * Booking.js
	 * http://timekit.io
	 *
