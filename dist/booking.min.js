!function(e,t){"object"==typeof exports&&"object"==typeof module?module.exports=t(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof exports?exports.TimekitBooking=t(require("jquery")):e.TimekitBooking=t(e.jQuery)}(this,function(e){return function(e){function t(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return e[i].call(r.exports,r,r.exports,t),r.loaded=!0,r.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function i(){var e,t,i,u,d={},h=function(){e=r(d.targetEl),0===e.length&&(e=r("#hourwidget")),0===e.length&&l.logError("No target DOM element was found ("+d.targetEl+")"),e.addClass("bookingjs"),e.children(":not(script)").remove()},f=function(){d.app&&(d.timekitConfig.app=d.app),o.configure(d.timekitConfig)},p=function(){o.setUser(d.email,d.apiToken)},g=function(){var e={};d.timekitFindTime.calendar_ids||d.timekitFindTime.user_ids||(e.emails=[d.email]),r.extend(e,d.timekitFindTime),l.doCallback("findTimeStarted",d,e),o.findTime(e).then(function(e){l.doCallback("findTimeSuccessful",d,e),_(),e.data.length>0&&D(e.data)}).catch(function(e){l.doCallback("findTimeFailed",d,e),l.logError(["An error with Timekit FindTime occured, context:",e]),_()})},m=function(){var e={url:"/findtime/team",method:"post",data:d.timekitFindTimeTeam};r.each(d.timekitFindTimeTeam.users,function(e,t){r.extend(t,d.timekitFindTime),t.calendar_ids||t.user_ids||(t.emails=[t._email])}),l.doCallback("findTimeTeamStarted",d,e),o.makeRequest(e).then(function(e){l.doCallback("findTimeTeamSuccessful",d,e),_(),e.data.length>0&&D(e.data)}).catch(function(e){l.doCallback("findTimeTeamFailed",d,e),l.logError(["An error with Timekit FindTimeTeam occured, context:",e]),_()})},v=function(){l.doCallback("GetBookingSlotsStarted",d);var e={url:"/bookings/groups",method:"get"};d.widgetId&&(e.params={search:"widget.id:"+d.widgetId}),o.makeRequest(e).then(function(e){var t=e.data.map(function(e){return{title:e.attributes.event_info.what,start:e.attributes.event_info.start,end:e.attributes.event_info.end,booking:e}});l.doCallback("getBookingSlotsSuccessful",d,e),_(),t.length>0&&D(t)}).catch(function(e){l.doCallback("getBookingSlotsFailed",d,e),l.logError(["An error with Timekit GetBookings occured, context:",e]),_()})},b=function(){C(),t.fullCalendar("removeEventSources"),"group_customer"===d.bookingGraph||"group_customer_payment"===d.bookingGraph?v():d.timekitFindTimeTeam?m():g()},y=function(e){t.fullCalendar("gotoDate",e);var n=s(e).format("H");w(n)},w=function(e){if("agendaWeek"===t.fullCalendar("getView").name){var n=t.fullCalendar("option","slotDuration"),i=30;n&&(i=n.slice(3,5));var o=t.find(".fc-slats .fc-minor"),a=r(o[0]).height()*(60/i),l=0;if(d.fullCalendar.minTime){var c=s(d.fullCalendar.minTime,"HH:mm:ss").format("H");l=a*c}var u=a*e-l,h=t.find(".fc-scroller"),f=h.height(),p=h.scrollTop(),g=h.find(".fc-time-grid").height();u>p&&u<p+f||(u>g-f&&(u=g-f),h.animate({scrollTop:u}))}},k=function(){var t=s().utcOffset()/60,i=n(57),c=n(9),u=r(c.render({timezoneIcon:i,loadingText:d.localization.strings.timezoneHelperLoading,loading:!0}));e.addClass("has-timezonehelper"),e.append(u);var h={email:d.email};l.doCallback("getUserTimezoneStarted",d,h),o.getUserTimezone(h).then(function(e){l.doCallback("getUserTimezoneSuccessful",d,e);var o=e.data.utc_offset,s=t-o,c=Math.abs(t-o),h=s>0?"ahead":"behind",f=n(9),p=r(f.render({timezoneIcon:i,timezoneDifference:0!==c,timezoneDifferent:a.sprintf(d.localization.strings.timezoneHelperDifferent,c,h,d.name),timezoneSame:a.sprintf(d.localization.strings.timezoneHelperSame,d.name)}));u.replaceWith(p)}).catch(function(e){l.doCallback("getUserTimezoneFailed",d,e),l.logError(["An error with Timekit getUserTimezone occured, context:",e])})},S=function(){var n=x(d.fullCalendar.defaultView),i={height:n.height,eventClick:A,windowResize:function(){var e=x();t.fullCalendar("changeView",e.view),t.fullCalendar("option","height",e.height)}};r.extend(!0,i,d.fullCalendar),i.defaultView=n.view,t=r('<div class="bookingjs-calendar empty-calendar">'),e.append(t),t.fullCalendar(i),e.addClass("show"),l.doCallback("fullCalendarInitialized",d)},A=function(e){d.disableConfirmPage?(r(".fc-event-clicked").removeClass("fc-event-clicked"),r(this).addClass("fc-event-clicked"),l.doCallback("clickTimeslot",d,e)):M(e)},x=function(n){n=n||t.fullCalendar("getView").name;var i=d.fullCalendar.defaultView,r=420;return e.width()<480?(r=380,e.addClass("is-small"),d.avatar&&(r-=15),"agendaWeek"!==n&&"basicDay"!==n||(i="basicDay")):e.removeClass("is-small"),d.bookingFields.comment.enabled&&(r+=84),d.bookingFields.phone.enabled&&(r+=64),d.bookingFields.voip.enabled&&(r+=64),d.bookingFields.location.enabled&&(r+=64),d.localization.showTimezoneHelper||(r+=33),{height:r,view:i}},D=function(e){var n=s(e[0].start),i=s(e[0].end),r=i.diff(n,"minutes");r<=90&&t.fullCalendar("option","slotDuration","00:15:00"),t.fullCalendar("addEventSource",{events:e}),t.removeClass("empty-calendar"),d.goToFirstEvent&&y(e[0].start)},E=function(){var t=n(46),i=r(t.render({image:d.avatar}));e.addClass("has-avatar"),e.append(i)},T=function(){var t=n(47),i=r(t.render({name:d.name}));e.addClass("has-displayname"),e.append(i)},C=function(){l.doCallback("showLoadingScreen",d);var t=n(44);u=r(t.render({loadingIcon:n(11)})),e.append(u)},_=function(){l.doCallback("hideLoadingScreen",d),u.removeClass("show"),setTimeout(function(){u.remove()},500)},M=function(t){l.doCallback("showBookingPage",d,t);var o=n(42),c=n(43),u=d.localization.bookingDateFormat||s.localeData().longDateFormat("LL"),h=d.localization.bookingTimeFormat||s.localeData().longDateFormat("LT");i=r(c.render({chosenDate:s(t.start).format(u),chosenTime:s(t.start).format(h)+" - "+s(t.end).format(h),closeIcon:n(54),checkmarkIcon:n(53),loadingIcon:n(11),errorIcon:n(55),submitText:d.localization.strings.submitText,successMessageTitle:d.localization.strings.successMessageTitle,successMessageBody:a.sprintf(d.localization.strings.successMessageBody,'<span class="booked-email"></span>'),fields:d.bookingFields},{formFields:o}));var f=i.children(".bookingjs-form");i.children(".bookingjs-bookpage-close").click(function(e){e.preventDefault(),z();var t=r(f).hasClass("success");t&&b()}),t.users&&l.logDebug(["Available users for chosen timeslot:",t.users],d),f.submit(function(e){R(this,e,t)}),d.showCredits&&O(i),r(document).on("keyup",function(e){27===e.keyCode&&z()}),e.append(i),setTimeout(function(){i.addClass("show")},100)},z=function(){l.doCallback("closeBookingPage",d),i.removeClass("show"),setTimeout(function(){i.remove()},200),r(document).off("keyup")},R=function(e,t,n){t.preventDefault();var i=r(e);if(i.hasClass("loading")||i.hasClass("success")||i.hasClass("error")||!t.target.checkValidity()){var o=i.find(".bookingjs-form-button");return o.addClass("button-shake"),void setTimeout(function(){o.removeClass("button-shake")},500)}var a={};r.each(i.serializeArray(),function(e,t){a[t.name]=t.value}),i.addClass("loading"),l.doCallback("submitBookingForm",d,a),L(a,n).then(function(e){i.find(".booked-email").html(a.email),i.removeClass("loading").addClass("success")}).catch(function(e){H(i)})},H=function(e){var t=e.find(".bookingjs-form-button");t.addClass("button-shake"),setTimeout(function(){t.removeClass("button-shake")},500),e.removeClass("loading").addClass("error"),setTimeout(function(){e.removeClass("error")},2e3)},L=function(e,t){var n={event:{start:t.start.format(),end:t.end.format(),what:d.name+" x "+e.name,where:"TBD",description:"",calendar_id:d.calendar,participants:[e.email]},customer:{name:e.name,email:e.email,timezone:s.tz.guess()}};if(d.bookingFields.location.enabled&&(n.event.where=e.location),d.bookingFields.comment.enabled&&(n.event.description+=d.bookingFields.comment.placeholder+": "+e.comment+"\n"),d.bookingFields.phone.enabled&&(n.customer.phone=e.phone,n.event.description+=d.bookingFields.phone.placeholder+": "+e.phone+"\n"),d.bookingFields.voip.enabled&&(n.customer.voip=e.voip,n.event.description+=d.bookingFields.voip.placeholder+": "+e.voip+"\n"),r.extend(!0,n,d.timekitCreateBooking),"group_customer"!==d.bookingGraph&&"group_customer_payment"!==d.bookingGraph||(delete n.event,n.related={owner_booking_id:t.booking.id}),t.users){var i=t.users[0],a=r.grep(d.timekitFindTimeTeam.users,function(e){return i.email===e._email});if(a.length<1||!a[0]._calendar)return void l.logError(["Encountered an error when picking designated team user to receive booking",i,d.timekitFindTimeTeam.users]);o=o.asUser(i.email,i.token),n.event.calendar_id=a[0]._calendar,l.logDebug(["Creating booking for user:",i],d)}!t.users&&d.widgetId&&(n.widget_id=d.widgetId),l.doCallback("createBookingStarted",d,n);var c={"Timekit-OutputTimestampFormat":"Y-m-d "+d.localization.emailTimeFormat+" (P e)"},u=o.include("attributes","event","user").headers(c).createBooking(n);return u.then(function(e){l.doCallback("createBookingSuccessful",d,e)}).catch(function(e){l.logError(["An error with Timekit CreateBooking occured, context:",e]),l.doCallback("createBookingFailed",d,e)}),u},O=function(e){var t="widget",i=window.location.hostname.replace(/\./g,"-");d.widgetId&&(t="embedded-widget"),d.widgetSlug&&(t="hosted-widget");var o=n(45),a=n(56),s=r(o.render({timekitLogo:a,campaignName:t,campaignSource:i}));e.append(s)},P=function(e){return r.extend(!0,{},c.primary,e)},I=function(e,t,n){var i=c.presets[t][n];return i?r.extend(!0,{},i,e):e},j=function(e){(void 0===e||"object"!=typeof e||r.isEmptyObject(e))&&l.logError("No configuration was supplied or found. Please supply a config object upon library initialization");var t=P(e);return t=I(t,"timeDateFormat",t.localization.timeDateFormat),t=I(t,"bookingGraph",t.bookingGraph),t=I(t,"availabilityView",t.availabilityView),t.email||l.logError('A required config setting ("email") was missing'),t.apiToken||l.logError('A required config setting ("apiToken") was missing'),t.calendar||"group_customer"===t.bookingGraph||"group_customer_payment"===t.bookingGraph||t.timekitFindTimeTeam||l.logError('A required config setting ("calendar") was missing'),d=t,l.logDebug(["Final config:",d],d),l.logDebug(["Version:",F()],d),d},N=function(){return d},F=function(){return"1.13.0"},B=function(){return l.doCallback("renderStarted",d),h(),f(),p(),S(),b(),d.localization.showTimezoneHelper&&k(),d.avatar&&E(),d.name&&T(),l.doCallback("renderCompleted",d),this},G=function(e){return l.logDebug(["Supplied config:",e],e),!e.widgetId&&!e.widgetSlug||e.disableRemoteLoad?W(e):Y(e).then(function(t){var n=t.data.config;t.data.id&&(n.widgetId=t.data.id);var i=r.extend(!0,{},n,e);l.logDebug(["Remote config:",n],i),W(i)})},Y=function(e){return d=P(e),f(),e.widgetId?o.getEmbedWidget({id:e.widgetId}).catch(function(){l.logError("The widget could not be found, please double-check your widgetId")}):e.widgetSlug?o.getHostedWidget({slug:e.widgetSlug}).catch(function(){l.logError("The widget could not be found, please double-check your widgetSlug")}):void l.logError("No widget configuration, widgetSlug or widgetId found")},W=function(e){return j(e),B()},q=function(){return h(),d={},this},V=function(){if(void 0!==t.fullCalendar)return t.fullCalendar.apply(t,arguments)};return{setConfig:j,getConfig:N,getVersion:F,render:B,init:G,destroy:q,timekitCreateBooking:L,fullCalendar:V,timekitSdk:o}}/*!
	 * Booking.js
	 * http://timekit.io
	 *
