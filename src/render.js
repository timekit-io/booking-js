...
function InitRender(deps) {
    ...
    var renderFooter = function () {
        ...
        var timekitLogo = require('!svg-inline-loader!./assets/timekit-logo.svg');
        var timezoneIcon = require('!svg-inline-loader!./assets/timezone-icon.svg');
        var arrowDownIcon = require('!svg-inline-loader!./assets/arrow-down-icon.svg');
    ...
    var showBookingPage = async function (eventData) {
        ...
        if (booking_uuid) {
            var template = require('./templates/reschedule-page.html');
        } else {
